...
| Код        | Правило                           | Область      | Действие        | Примечание                        |
| ---------- | --------------------------------- | ------------ | --------------- | --------------------------------- |
| ST-PR-017  | Стандартное имя компонента        | Элемент      | Предупреждение  | В процессе используется стандартное имя элемента. Лучшей практикой считается давать элементу уникальное имя, указывающее на его назначение в процессе. Например, элемент "Присвоение" можно переименовать в "Присвоение <имя переменной>". Уникальное название элемента поможет при отладке быстрее понять, в каком элементе произошла ошибка |
