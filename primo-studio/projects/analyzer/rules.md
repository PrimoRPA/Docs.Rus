...
| ST-PRJ-001 | Пакетные ограничения              | Проект       | Ошибка    | Проект содержит пакеты, запрещенные в вашей организации. Правило имеет параметр "Запрещенные пакеты", где можно перечислить названия таких пакетов |
...
| ST-PR-028  | Повторяющиеся элементы в процессе | Процесс      | Предупреждение   | Повторяющиеся части с одинаковой функциональностью могут быть выделены в подпроцессы |
