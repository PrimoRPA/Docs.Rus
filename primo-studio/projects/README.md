...
По умолчанию в проекте сразу создается процесс `Main.ltw`, который автоматически открывается в виде вкладки в рабочей области Студии. Теперь вы можете перейти к нему, чтобы добавить элементы автоматизации. Элементы добавляются перетаскиванием из панели  «Элементы» в процесс. См. [пример здесь](https://docs.primo-rpa.ru/primo-rpa/primo-studio/process/sequence#dobavlenie-elementov).
