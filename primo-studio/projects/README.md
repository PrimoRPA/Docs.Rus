...
RPA-проектом в Primo RPA Studio называется набор сценариев автоматизации ([процессов](https://docs.primo-rpa.ru/primo-rpa/primo-studio/process)), сгруппированных по папкам. Структура проекта отображается на панели «Проект». В рамках файловой системы проект представляет собой следующий вид:
