...
Утилита PrimoImportFix позволяет корректировать \*.ltw файлы Primo Studio, сформированные после процедуры [импорта](https://docs.primo-rpa.ru/primo-rpa/primo-studio/instrumenty/import) из проекта UiPath. Инструмент встроен в Primo Studio и доступен в разделе меню **Инструменты ➝ Открыть PrimoImportFix**.
...
После запуска инструмента PrimoImportFix появляется диалог с предложением выбрать один или несколько \*.ltw файлов проекта для преобразования. 
