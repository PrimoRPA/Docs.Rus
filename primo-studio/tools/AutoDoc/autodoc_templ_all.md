...
Также рекомендуется внимательно изучить содержимое файлов `.csv`, которые находятся в папке **Resources**. Эти файлы представляют собой словари или списки соответствий для отображаемых значений, используемых при описании внутренних наименований типов, свойств и других элементов.
...
```
 ...
 ![](<../../.gitbook/assets1/uml_autodoc.png>)

На изображении выше показан результат рендеринга UIControlsTest.uml, созданной с помощью **Template.uml**, с использованием тегов для отображения названия и содержимого процесса.
