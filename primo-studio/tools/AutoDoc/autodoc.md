...
В папке Resources содержатся файлы настроек и шаблоны, необходимые для генерации документации.
также находятся подпапки **assets** и **mazer**, которые включают скрипты, шрифты и файлы изображений для оформления выходных документов.
...
- *Template.docx* - шаблон автоматической генерации описания проекта в формате документа **MS Word**
...
- *elements.csv* — описывает активности, включая группу, описание и название класса.
  ...
  Эти файлы представляют собой словари или списки соответствий для отображаемых значений, используемых при описании внутренних наименований типов, свойств и других элементов.
...
- Для создания документов в формате Word используйте параметр `-word`.
