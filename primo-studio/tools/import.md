...
4\. В случае успеха в таблице появится список файлов проекта. Чтобы выбрать из них файлы, которые импортировать, поставьте рядом отметку либо нажмите кнопку **Check all** ![](<../../.gitbook/assets/import-check-all.png>), чтобы выбрать сразу весь список. 
