...
* Создать переменную - `Ctrl` + `K`. Если при этом выделено свойство элемента, где нужно указать переменную, то в окне создания будет задан нужный тип данных для переменной этого свойства.
* Создать аргумент - ?
