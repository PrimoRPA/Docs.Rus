...
18. **Отладчик чистого кода** - параметр добавлен в версии 23.11. По умолчанию используется ядро v1 - прежнее ядро.
    ...
    :small_orange_diamond: ***При смене версии ядра - если ранее в проектах были использованы точки останова, заданные кодом (v1), рекомендуется их удалить и установить новые (v2). Рекомендация поможет избежать потенциальных проблем совместимости версий.***
