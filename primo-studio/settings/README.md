...
Чтобы открыть окно конфигурации Студии, нажмите в меню **Файл > Настройки**. 
...
3. **Логировать в файл** - определяет, нужно ли сохранять журнал Студии в [файле](https://docs.primo-rpa.ru/primo-rpa/primo-studio/process/log). Пример пути к сохраненному файлу: `C:\Users\UserName\AppData\Local\Primo.Primo Studio\Log`. Название файла: `<число месяц год час>_RobotStudio.log`.
