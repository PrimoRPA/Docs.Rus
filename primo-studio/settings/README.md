...
2. Включите чекбокс **Использовать AI** - в меню Студии появится функция **Чат AI**.

   ![](<../../.gitbook/assets1/aichat-black.png>)

3. Выберите нейросеть:
   * Sber GPT - установлена по умолчанию.
   * Yandex GPT.

:small_blue_diamond: *Дальнейший набор параметров зависит от выбранной AI.*

GigaChat:
* **Token** - введите токен для подключения.
* **Key** - ?
