...
2. Перезагрузите Студию.
3. Перейдите в настройки интеграции и включите чекбокс **Использовать AI**. Выберите нейросеть:
...
4. Укажите оставшиеся настройки для выбранной AI.
