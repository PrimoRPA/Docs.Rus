...
18. **Отладчик чистого кода** - параметр добавлен в версии 23.11. По умолчанию используется ядро v1 - прежнее ядро.
    ...
    :small_blue_diamond: ***При смене версии ядра*** - *если ранее в проектах были использованы точки останова, заданные кодом (v1), удалите их и установите новые (v2). Это поможет избежать потенциальных проблем совместимости.*
