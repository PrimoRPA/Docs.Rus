...
Параметры:
1. **Использовать AI** - установите чекбокс, чтобы в меню Студии появилась функция **Чат AI**.
2. Выберите нейросеть:
  * Sber GPT - по умолчанию.
  * Yandex GPT.

Дальнейший набор параметров зависит от выбранной AI.
