...
1. **Кол-во строк журнала** - максимальное отображаемое количество строк в панели «Консоль».
...
3. **Логировать в файл** - определяет, нужно ли сохранять журнал отладчика в файле.
...
В данной панели настроиваются функции отладчика:
...
2. **Закрывать робота** - автоматическое закрытие робота по завершении процесса.
3. **Отображать консоль робота** - отображает консоль робота при отладке.
4. **Сворачивать Студию** - сворачивать ли Студию при отладке.
5. **Отображать окно консоли** - отображает окно консоли при отладке.
6. **Проверять синтаксис** - автоматическая проверка синтаксиса.
