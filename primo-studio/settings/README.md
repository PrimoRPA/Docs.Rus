...
3. **Логировать в файл** - определяет, нужно ли сохранять журнал отладчика в [файле](https://docs.primo-rpa.ru/primo-rpa/primo-studio/process/log).
...
7. **Отображать лупу** - управляет отображением лупы селектора в верхнем углу экрана. Если настройка включена, то лупа при выборе элемента управления будет отображаться. Пример:
...
2. **Отключить логирование у новых элементов** - управляет автоматическим логированием элементов, добавляемых в проект. Параметр позволяет массово изменить значение свойства [Отключить логирование](https://docs.primo-rpa.ru/primo-rpa/primo-studio/process/elements#svoistva-elementa) у новых элементов:
