...
18. **Отладчик чистого кода** - добавлен в версии 1.23.11. Позволяет выбрать ядро робота-отладчика: `v1` или `v2` (новая версия). 
    ...
    :small_orange_diamond: Нельзя использовать неициализированные переменные с отладчиком `v2`.
