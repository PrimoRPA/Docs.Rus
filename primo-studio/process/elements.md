...
{% hint style="info" %} При отключении логирования для элемента 'Исключение', само исключение будет продолжать логироваться в рамках пакетного логирования. Это гарантирует фиксацию данных об ошибках и исключениях независимо от настроек для остальных элементов. {% endhint %}
