...
Все доступные компоненты процесса находятся в специальной панели **Элементы**, сгруппированные по тематике. 
...
Свойства могут быть отображены в виде обычного списка или в виде групп. Для переключения режимов используйте кнопки ![](<../../.gitbook/assets/1 (124).png>). Если элемент обладает слишком большим списком свойств, можно воспользоваться поисковой строкой в верхней части панели.
