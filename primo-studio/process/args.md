...
5. На странице Оркестратора **RPA-проекты > Все RPA-проекты** для проекта с аргументами станет доступна вкладка **Аргументы**. На ней отобразятся значения по умолчанию для всех аргументов проекта, со всеми направлениями: **In**, **InOut**, **Out**. Значения в этой вкладке доступны только для просмотра, изменять их нельзя.
