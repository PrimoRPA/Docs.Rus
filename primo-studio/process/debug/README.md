...
1. **Просмотр значения**. Чтобы просмотреть результат вычисления, нажмите иконку ![](../../../.gitbook/assets/ViewVariable.png) в столбце **Значение**. Отображенный результат можно скопировать комбинацией клавиш `Ctrl` + `C` либо командой контекстного меню.
1. **Обновление результата**. Обновить результат вычисления можно иконкой ![](../../../.gitbook/assets/RefreshWatch.png) в строке с соответствующим наблюдением. Запрос обновления выполнится корректно только, если запущена отладка процесса.
