...
Студия предоставляет возможность протестировать готовый RPA-сценарий до публикации проекта. Процесс можно запустить внутри Студии и отследить его выполнение.
