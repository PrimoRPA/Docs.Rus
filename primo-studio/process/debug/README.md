...
Чтобы создать новое наблюдение, нажмите иконку ![](<../../../.gitbook/assets/12 (2) (3) (1) (1) (2) (1) (2).png>) в левом верхнем углу панели. После чего введите текст вычисляемого выражения в открывшемся окне:

![](../../../.gitbook/assets/15.png)

Обновить результат вычисления можно по кнопке **Обновить** ![](../../../.gitbook/assets/RefreshWatch.png) в строке с соответствующим наблюдением. Запрос обновления выполняется корректно только, если запущена отладка процесса.
