...
Под этими кнопка находятся фильтры DEBUG, INFO, ERROR, NETWORK и TEST. Они отвечают за сбор сообщений с соответствующим типом.
...
* Копирование - выделите сообщение, вызовите его контекстное меню и выберите команду «Копировать» (либо нажмите `Ctrl` + `C`). Для множественного копирования сначала выделите все нужные сообщения, после чего примените команду.

Дополнительные настройки консоли доступны в контекстном меню. Чтобы его вызвать, кликните правой кнопкой мыши по названию любого столбца. 

Так, команда **Показать выбор колонок** позволяет настроить отображение столбцов таблицы.
