...
Обновить результат вычисления можно по кнопке **Обновить** ![](../../../.gitbook/assets/RefreshWatch.png) рядом с соответствующим выражением. Запрос обновления выполняется корректно только, если запущена отладка процесса.
