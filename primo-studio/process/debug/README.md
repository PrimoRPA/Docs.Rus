...
Студия предоставляет возможность проверить работоспособность RPA-сценария до публикации проекта. Процесс можно запустить внутри Студии и просмотреть результат его выполнения.
