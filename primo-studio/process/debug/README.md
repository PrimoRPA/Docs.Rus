...
:bangbang: ***Обратите внимание на колонку «Номер». В ней выводится информация о номере, присвоенном элементу в процессе. Стобец отображается, только если специально отметить его в окне выбора колонок.***

Отключить автонумерацию элементов можно в настройках [оформления](https://docs.primo-rpa.ru/primo-rpa/primo-studio/settings#oformlenie) Студии, сняв чекбокс **Отображать нумерацию**.
