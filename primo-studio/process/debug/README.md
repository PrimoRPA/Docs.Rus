...
:bangbang: ***Обратите внимание на колонку «Номер». В ней выводится информация о номере, присвоенном элементу\* в процессе. Колонка не отображается по умолчанию, ее нужно выбирать в меню.***
...
Инструмент отключает тот или иной элемент при отладке. Чтобы его применить, нажмите иконку ![](../../../.gitbook/assets/ignore.png) в заголовке нужного элемента: 
...
:bangbang: ***[См. здесь, как установить точку останова в процессе Только код (Pure code)](https://docs.primo-rpa.ru/primo-rpa/primo-studio/process/coding#tochka-ostanova-i-vyvod).***
...
Чтобы изменить значение переменной, вызовите ее контекстное меню в панели «Вывод» и выберите пункт **Change value**.

![](../../../.gitbook/assets1/output-change-value-in-context-menu.png)

Функциональность может пригодиться при паузах на исключении, чтобы быстро исправить значение и возобновить выполнение процесса (кнопка **Повтор шага**).
