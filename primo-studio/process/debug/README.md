...
1. **Редактирование**. Изменить вычисляемое выражение можно в ячейке таблицы либо в окне редактирования, которое открывается, если дважды кликнуть мышью на нужном наблюдении.
1. **Удаление**. Чтобы удалить наблюдение, выделите строку в таблице и нажмите иконку ![](<../../../.gitbook/assets/13 (1) (1) (2) (1) (1) (2) (1) (8).png>) либо клавишу `Delete`.
