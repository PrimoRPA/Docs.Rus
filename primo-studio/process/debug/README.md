...
Колонка «Номер» отображается, только если специально отметить ее в окне выбора колонок. Отключить автонумерацию элементов можно в настройках [оформления](https://docs.primo-rpa.ru/primo-rpa/primo-studio/settings#oformlenie) Студии, сняв чекбокс **Отображать нумерацию**.
