...
* копирование - выделите нужное сообщение, вызовите его контекстное меню и выберите команду **Копировать**. Также горячими клавишами `Ctrl` + `C` можно скопировать всю информацию из Консоли.
