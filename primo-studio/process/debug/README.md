...
1. **Создание**. Чтобы создать новое наблюдение, нажмите иконку ![](<../../../.gitbook/assets/12 (2) (3) (1) (1) (2) (1) (2).png>) в левом верхнем углу панели. После чего введите текст вычисляемого выражения в открывшемся окне:

   ![](../../../.gitbook/assets/15.png)

1. **Просмотр значения**. Для просмотра значения нажмите кнопку **Просмотр** ![](../../../.gitbook/assets/ViewVariable.png). Выбранное значение можно скопировать комбинацией клавиш `Ctrl` + `C` либо командой контекстного меню.
1. **Обновление результата**. Обновить результат вычисления можно по кнопке **Обновить** ![](../../../.gitbook/assets/RefreshWatch.png) в строке с соответствующим наблюдением. Запрос обновления выполняется корректно только, если запущена отладка процесса.
1. **Редактирование**. Изменить вычисляемое выражение можно в ячейке таблицы либо в окне редактирования, которое открывается двойным кликом мыши на нужном наблюдении.
1. **Удаление**. Чтобы удалить наблюдение, выделите строку в таблице и нажмите кнопку **Удалить наблюдение** ![](<../../../.gitbook/assets/13 (1) (1) (2) (1) (1) (2) (1) (8).png>) либо клавишу `Delete`.
