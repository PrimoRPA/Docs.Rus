...
1. **Режим** - иконка выбора между категориями приложений, для которой создается шаблон: Браузер, Рабочий стол, SAP. Также доступен режим Контейнер, о котором подробнее сказано в подразделе [**Выбор категории приложений**](https://docs.primo-rpa.ru/primo-rpa/primo-studio/process/searchpatterns#vybor-kategorii-prilozhenii).
