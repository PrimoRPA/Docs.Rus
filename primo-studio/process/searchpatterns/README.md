...
Чтобы автоматически сформировать шаблон, используйте кнопку **Выбрать компонент** ![](<../../../.gitbook/assets/image (553).png>) — она вызывает захват элемента управления в соответствующей категории приложения. Кнопка находится панели элемента или в его свойствах. Пример:
