...
Функция **Быстрый поиск** включена по умолчанию и активирует укороченный маршрут поиска компонента в приложении. Практика применения такова: если в режиме быстрого поиска компонент не находится, отключите параметр и произведите поиск еще раз. Быстрый поиск хорошо работает с типом автоматизации UIAUTOMATION, а также рекомендуется при работе с 1С.
