...
Для удаления переменной необходимо выделить строчку с ней в таблице и, либо нажать кнопку Удалить переменную ![](<../../.gitbook/assets/3 (6).png>), либо нажать кнопку Delete.
