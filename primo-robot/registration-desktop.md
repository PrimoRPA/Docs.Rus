...
Лицензию для attended-робота возможно получить только через утилиту **Primo Robot Runner**. Ниже описана процедура регистрации робота при помощи лицензии **Robot (Desktop)** - локального ключа.
