...
Регистрация Робота локальным ключом (Robot Desktop) через Robot Runner подробно описана [здесь](https://docs.primo-rpa.ru/primo-rpa/primo-robot/installation/registration-desktop). Без регистрации полноценная работа с Роботом в Robot Runner невозможна.
