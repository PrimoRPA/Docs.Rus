...
> Начиная с версии 1.25.1 в форме добавления RDP-пользователя переключатель **Автоматически поддерживать RDP-сессию** выключен, в параметре "Уровень аутентификации" по умолчанию установлено в значение "Требуется аутентификация".
