...
1. Добавлены фильтры для раздела **Ресурсы(Assets)** в интерфейсе Оркестратора. Пользователи теперь могут фильтровать ресурсы по описанию, типу данных, параметру "Только для чтения", роботу и блокировке, а также видеть количество отфильтрованных элементов в верхней части таблицы.
