...
1. Исправлена работа функции **Повторить** для элементов очереди. Теперь использование функции всегда будет переводить элемент в статус New, независимо от текущего статуса.
...
1. Исправлена ошибка, когда для непоследних версий проектов не отображалась соответствующая надпись в таблице проектов. 
