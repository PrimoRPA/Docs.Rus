...
1. Добавлена возможность останавливать сразу все запущенные [задания](https://docs.primo-rpa.ru/primo-rpa/orchestrator/basics/tasks), а также массово запускать их впоследствии. Для этого на странице **Все задания** появились кнопки **Остановить все** и **Запустить все остановленные**. Для массовой остановки/запуска заданий не требуется предварительно выбирать задания в таблице.
...
1. Отключение виджета с интенсивностью событий триггеров на главной странице.
...
1. Исправлена сортировка элементов (FIFO) при чтении из очереди в скоростном режиме.
