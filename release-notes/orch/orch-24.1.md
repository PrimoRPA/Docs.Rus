...
1. 10088 - Большая нагрузка на процессор при работе RDP2. ??? сделали что-то? 
...
1. Исправлена ошибка, из-за которой задание с запуском при изменении папки учитывало только глобальную настройку стратегии очереди. Сейчас учитываются также и тенантные стратегии.
