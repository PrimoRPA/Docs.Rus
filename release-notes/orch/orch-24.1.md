...
1. Исправлены ошибки в сортировке элементов очереди, возникавшие при большом количестве обращений. 
...
1. Исправлена ошибка, из-за которой....стратегии очереди проектов. бралась глобальная настройка, а не тенантная. 
