...
1. На странице **Все роботы** добавлена подсветка недоступной машины робота. Так, если в столбце **Машина доступна** отображается статус *Нет*, то он подсветится красным. 
