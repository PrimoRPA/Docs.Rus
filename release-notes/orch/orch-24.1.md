...
1. При создании/редактировании элемента очереди стало возможным указать тайм-аут (в прод версии и в hope-ui). По умолчанию параметр **Тайм-аут** скрыт, настроить его отображение можно в конфигурационном файле WebAPi в параметре **EnabledInProgressTimeout**. 
   ___
