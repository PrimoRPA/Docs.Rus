...
1. Исправлена ошибка `Email должен быть уникальным`, которая возникала при редактировании адреса в профиле пользователя.
1. Исправлена ошибка валидации Email для заданий с триггером **Запуск при получении Email**. 
