...
1. В журнале Оркестратора вновь стала доступной вкладка **Корректировка**. Она предназначена для вывода событий о корректировке оперативного взаимодействия узлов кластера Оркестратора. На вкладке доступен фильтр по следующим типам событий:
