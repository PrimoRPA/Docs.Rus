...
1. 10055 - Вернуть вкладку Коррекция в журнале логов оркестратора. раздел **Журнал**. Вернули вкладку **Корректировка** - отдельный лог по Оркестратору (что это значит?). Ранее был скрыт.
