...
1. Исправлена ошибка, из-за которой задание с запуском при изменении папки учитывало только глобальную настройку стратегии очереди. Сейчас учитываются также стратегии тенантов.
