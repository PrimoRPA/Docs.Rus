...
1. Для элемента очереди стало возможным указывать тайм-аут - максимальное время нахождения элемента в статусе InProgress (в прод версии и в hope-ui). По истечении указанного тайм-аута система автоматически удалит данный элемент. По умолчанию параметр скрыт, настроить его отображение можно в конфигурационном файле WebAPi в параметре **EnabledInProgressTimeout**. 
