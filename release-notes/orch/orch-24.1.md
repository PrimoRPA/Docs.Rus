...
"Сейчас оркестраторный робот работает под технической учеткой. И права учетке настроить нельзя. Если нужны права, то заводим учетку назначаем ей роль робот и (или?) другую если нужно. 



1. В форму развертывания робота добавлены необязательные параметры:
   * **Пользователь Оркестратора** - учетная запись с ролью Robot, которая создана вручную и предназначена для робота Оркестратора. Если оставить поле пустым, то будет использоваться встроенная учетная запись **robot**. 
