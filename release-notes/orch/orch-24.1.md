...
1. Для элемента очереди стало возможным указывать тайм-аут - максимальное время нахождения элемента в статусе InProgress (в прод версии и в hope-ui). По истечении указанного тайм-аута система автоматически удалит этот элемент. По умолчанию параметр тайм-аута скрыт, настроить его отображение можно в конфигурационном файле WebAPi в параметре **EnabledInProgressTimeout**. 
...
Верхняя часть (v0, …, vN) версии – это технические версии проектов внутри Оркестратора, назначаются Оркестратором автоматически. Нижняя часть версии – строка формата, принятого разработчиками проектов. Может заполняться на основе метаданных проекта, полученных при чтении архива проекта
...
1. Для RPA-проектов, в рамках интеграции с GitLab, добавилось визуальное обозначение источника публикации (...которые приходятс гитлаба для проектов). Источник отображается в столбце **Версия** в таблице **Все RPA-проекты**. По умолчанию скрыто\нет? За отображение источника публикации в интерфейсе отвечает параметр **какой?** в конфигурационном файле WebApi. 
   Возможные источники:
