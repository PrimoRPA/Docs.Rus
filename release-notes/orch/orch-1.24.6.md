...
2. Добавлена опция **Тип блокировки** во вкладке Роботы > Ресурсы (Assets) в свойствах ассета , позволяющая роботам устанавливать временную блокировку на ассет. Это предотвращает чтение или запись заблокированного ассета другими роботами до снятия блокировки или истечения таймаута. Для работы с этой функцией реализован новый элемент **Заблокировать ассет** в Студии.
