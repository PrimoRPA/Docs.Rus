...
1. Добавлена интеграция с **CyberArk**  в форме **Ресурсы** -> **Добавить/Редактировать ресурс** для централизованного управления учетными данными.

https://azure-dos.s1.primo1.orch/PrimoCollection/Orchestrator/_workitems/edit/15622

2. Добавлена возможность фильтрации проектов по источнику публикации.
...
https://azure-dos.s1.primo1.orch/PrimoCollection/Orchestrator/_workitems/edit/17243

36. Исправлена уязвимость с Nuget.Packaging в службе **RobotLogs**. Использованы последние версии пакетов NuGet.
https://azure-dos.s1.primo1.orch/PrimoCollection/Orchestrator/_workitems/edit/19308
