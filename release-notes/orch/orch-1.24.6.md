...
1. Добавлена возможность автоматического удаления элементов очереди, находящихся в статусе `InProgress` дольше заданного таймаута. Эта функция активируется, если параметр `EnabledInProgressTimeout`  установлен в true в конфигурационном файле. Поле для настройки этой функции отображается на странице редактирования элемента очереди только при включенном параметре.
