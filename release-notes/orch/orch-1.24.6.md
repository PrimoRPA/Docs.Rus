...
Для работы с этой функцией в Студии реализован новый элемент **Заблокировать ассет**.

![](../../.gitbook/assets1/asset_block.png)  скриншот
...
![](../../.gitbook/assets1/ad.png) Скриншот
