...
1. В раздел RPA-проектов добавлены вкладки:
   ...
   * **Запуски** — на вкладке отображается таблица с историей запуска проектов. Проекты могут иметь разные статусы: в ожидании, в процессе работы и завершенные. Чтобы просмотреть значения аргументов, с которыми был запущен проект, необходимо нажать кнопку **Показать детализацию запуска**.
