...
\
В текущей версии ресурсы и очереди обмена данными могут находиться только в корневой папке. Возможность их использования в некорневых папках планируется реализовать в следующих релизах.
