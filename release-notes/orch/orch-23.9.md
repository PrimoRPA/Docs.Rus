...
----------
1. Оркестратор перешел на новую платформу .NET 7. Ключевым достоинством платформы является более высокая производительность. (У нее выше производительность, лучшая  ИБ у библиотек)
...
6. (893) В части API выполнены общие папки (реализованы методы т.е.?). Папки ЕСТЬ. 
