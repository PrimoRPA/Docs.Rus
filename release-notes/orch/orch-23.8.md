...
1. Максимальная длина названия Робота увеличена до 200 символов. Теперь можно присваивать более полные и ясные значения.
2. Максимальная длина названия расписания увеличена до 250-ти символов.
...
1. 1076 - Исправлена ошибка с logmsgtypes=0 в Run.ps1. это про то что нужно отключать вывод логов в консоль. 
