...
1. Улучшены виджеты **Использование лицензий Робота** и **Использование лицензий Студии** в разделе **Обзор**.

3. 202, 961 - Реализовать отображение используемых лицензий + Поменять метод для запроса файла лицензии на v2
Вывести в виджетах Использование лицензий робота и Использование лицензий студии в описание статусов количество ( формат - 00 )
