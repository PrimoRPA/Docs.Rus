...
1. Корректна ли формулировка: "Улучшен UX/UI раздела **Роботы > Все роботы**. При невозможности разблокировать робота система отобразит сообщение о возможных причинах (например, о потере связи с машиной робота)".
...
5. Статус релизной задачи, берем или нет ее в релиз (на демо была с 5.30 мин в 1-й части) https://azure-dos.s1.primo1.orch/PrimoCollection/Orchestrator/_boards/board/t/Orchestrator%20Team/Stories/?workitem=3564 
6. 
