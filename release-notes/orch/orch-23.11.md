...
1. В разделе **Настройки > Email входящей почты** добавилась возможность выбрать **MS Exchange** в качестве протокола. При выборе этого значения отобразится поле **EWSUrl** - адрес сервера входящей почты. Также, для удобства пользователей, была оптимизирована таблица почтовых адресов: вместо колонок с протоколами и портами теперь выводится одна - **Протокол**. При наведении курсора на тот или иной протокол можно увидеть его параметры: например, имя сервера и порт.
