...
1. В форме Ролей добавить чекбоксы для выделения всех колонки

В шапке с ролями добавить чекбоксы по клику на который выделять все элементы (кроме не заблокированных) которые относяться к этой колонки, по повторному клику выделение убираем
