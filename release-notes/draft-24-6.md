...
1. Расширение Primo RPA Extension обновлено до версии 1.63. Обновленное расширение стало поддерживать взаимодействие с веб-клиентом 1С при помощи элементов из группы «Браузер», в том числе выбирать шаблон поиска с помощью xPath. Улучшение распространяется на обе версии Манифеста.
