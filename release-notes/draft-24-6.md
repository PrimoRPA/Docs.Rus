...
1. Расширены возможности поиска в проекте — теперь возможно заменить найденный текст на заданное значение. Функция замены призвана сократить время, требуемое для внесения изменений в RPA-проект. По умолчанию функция недоступна, чтобы ее активировать, необходимо включить в настройках Студии параметр **Найти и заменить**.
