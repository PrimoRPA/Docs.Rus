...
## Новые функции 
1. В настройках Студии появился чекбокс **Отключить логирование у новых элементов** (Disable logging for new items), он добавлен на вкладку **Общие > Элементы**. Параметр управляет автоматическим логированием добавленных элементов. По умолчанию чекбокс установлен - добавление новых элементов в проект **не** логируется. 
