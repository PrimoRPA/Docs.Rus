...
## Новые функции 
1. В настройках Студии появился чекбокс [**Отключить логирование у новых элементов**](https://docs.primo-rpa.ru/primo-rpa/primo-studio/settings#elementy) (Disable logging for new items), который управляет автоматическим логированием новых элементов в проекте. Параметр позволяет массово изменить значение свойства [**Отключить логирование**](https://docs.primo-rpa.ru/primo-rpa/primo-studio/process/elements#svoistva-elementa) у добавляемых элементов:
...
1. Добавлена поддержка горячих клавиш в окне аргументов [**Ссылки на процесс**](https://docs.primo-rpa.ru/primo-rpa/g_elements/el_basic/els_logic/el_logic_link). При открытии окна стало возможным:
...
1. При установке стиля ссылок R1C1 в параметрах Excel и в свойствах контейнера **Приложение Excel** попытки чтения файла либо ввода данных в ячейку заканчивались ошибкой. С этой версии использование стиля R1C1 не приводит к ошибке. 
...
1. В процессе с типом **Только код** (Pure Code) не учитывались ошибки в вызванном подпроцессе, соответствующие записи в консоли Студии не отображались. С этой версии ошибки подпроцесса выводятся в консоль, проект при их обнаружении перестает выполняться.
...
1. Элемент **Множественное присвоение** не открывался в диаграммах. Данная ошибка исправлена.
...
1. В некоторых процессах не открывалась диаграмма. С этой версии открытие диаграмм производится корректно.
