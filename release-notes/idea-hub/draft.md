...
* Появилась возможность создавать произвольное количество страниц с дашбордами. На странице дашборда предзаданы панели с метриками — панели доступны для редактирования. Метрики в панели отображаются в более понятном и приятном виде.
