...
Кроме того:
* Обновиили представление статистики запусков проекта: (скрин общее количество запусков, кол-во успешных запусков, кол-во запусков с ошибками, кол-во запусков с исключениями). 
* Перестали учитывать в статистике запусков проектов данные по версиям проекта - вместо этого отображаются общие данные по всем версиям.
