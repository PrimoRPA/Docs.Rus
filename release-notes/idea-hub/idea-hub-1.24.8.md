...
1. Стали доступны подсказки при вводе формул. Если ввести текст в поле формулы, то система автоматически отобразит подсказки, которые относятся к вашему коду. Кроме того, доступны операторы:
