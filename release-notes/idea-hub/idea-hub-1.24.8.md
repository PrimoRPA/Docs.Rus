...
1. Добавлена возможность управлять доступом к каждому полю процесса (только процесса или всех материалов?). **Какие разрешения появились, подробнее расписать, где настраиваются** https://azure-dos.s1.primo1.orch/PrimoCollection/IdeaHub/_workitems/edit/25778
