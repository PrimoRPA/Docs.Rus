...
Теперь статистика запуска проектов и обработки элементов очередей стала собираться ежедневно. Новый механизм сбора статистики позволяет более гибко и точно считать эффекты от автоматизации:
