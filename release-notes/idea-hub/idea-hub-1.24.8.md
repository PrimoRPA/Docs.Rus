...
1. Значительно улучшена работа с формулами:
   * Появилась возможность создавать и использовать переменные для написания формул любой сложности. При создании переменной следует использовать формат YAML.
   * Добавлена возможность оставлять комментарии с помощью синтаксиса `//Комментарий к формуле`. Комментарии помогут ориентироваться в сложной формуле.
   * Стало возможным пользоваться справочная информация:
