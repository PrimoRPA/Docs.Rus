...
реализовали ежедневный сбор статистики запуска проектов и обработки элементов очередей. Теперь статистика датирована и может быть дозаписана, исправлена (задним числом).
