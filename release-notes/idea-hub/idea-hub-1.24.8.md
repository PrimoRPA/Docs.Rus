...
Теперь статистика запуска проектов и обработки элементов очередей стала собираться ежедневно. Новый механизм сбора статистики позволяет более гибко считать эффекты от автоматизации:
