...
Добавили возможность выгружать статистику по очередям/проектам процесса в файл Excel. Выгружать статистику возможно за определенные даты или выбранный период: квартал, календарный месяц и т.д.
