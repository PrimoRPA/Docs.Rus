...
Добавили предупреждение о создании в Оркестраторе проекта с именем, которое уже используется в процессе Idea Hub. Новая функция позволит избежать некорректных данных по запускам и предоставляет возможность принимать обоснованные решения по управлению статистикой: вы можете объединить данные по проектам в одном процессе или создать новый процесс для их учета.
