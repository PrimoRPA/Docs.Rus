...
* Появилась возможность создавать произвольное количество страниц с дашбордами. На странице дашборда предзаданы панели с метриками — каждая панель доступна для редактирования.
* Метрики в панели отображаются в более понятном и приятном виде.
