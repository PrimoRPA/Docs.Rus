...
теперь система может понять, что что-то не то/есть похожее, одноименный проект и выдаст пользователю предупреждение (сделать скрин предупреждения). Дескать, есть другой проект с таким же именем, но он не связан с процессом. И пользователь может самостоятельно исправить ситуацию, например, привязать новый проект. И тогда ИХ выдаст совокупную стату в процессе по обоим проектам. Или привязать новый проект к новому процессу.

Вопросы:
1. Где отображается предупреждение
2. Как понять, какой проект новый, а какой старый
3. Можно ли удалить из ИХ старый проект, чтобы несколько проектов с одинаковым названием не отображались? (вроде нет)
