...
Функция обеспечивает безопасность данных, а также делает более удобным использование процессов для тех пользователей, которым для работы достаточно ограниченного количества полей. Таким образом, возможно снизить вероятность ошибок и сосредоточить внимание каждого пользователя на его ключевых задачах.
