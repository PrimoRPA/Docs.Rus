...
* Для дашборда появилась фильтрация по департаментам и по датам. Вы можете настроить отображение дашбордов только для связанных с ними департаментов и пользователей.
* Количество страниц с дашбордами может быть произвольным — на ваше усмотрение. 
