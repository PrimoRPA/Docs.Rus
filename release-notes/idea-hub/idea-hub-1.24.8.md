...
Мы добавили возможность использовать в расчетах статистику по разным прикрепленным к процессу очередям. Это означает, что к одному процессу мб подключено произвольное кол-во очередей и проектов, и мы можем делать сложные расчеты внутри формул путем комбинации данных из разных очередей. 
