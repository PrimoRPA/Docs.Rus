...
1. Для бизнес-процессов, к которым привязаны несколько очередей, появилась возможность выводить комбинированную статистику. Для этого в рассчитанных эффектах процесса появилось поле **Ops_total** - в данном поле вы можете ввести формулу с указанием необходимых очередей, по которым будут суммироваться показатели в статистике процесса.
