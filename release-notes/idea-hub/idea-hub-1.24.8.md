...
1. Добавлена возможность писать комментарии в формулах. Функция помогает упростить понимание и поддержку сложных формул. Комментарии будут игнорироваться при выполнении формулы, но останутся видимыми для всех, кто с ней работает. Чтобы оставить комментарий, используйте синтаксис `//Комментарий к формуле`. 
