...
1. Для бизнес-процессов, к которым привязаны несколько очередей, появилась возможность выводить комбинированную статистику. Для этого в рассчитанных эффектах процесса появилось поле **Ops_total** — в данном поле вы можете ввести формулу с указанием всех необходимых очередей, по которым следует суммировать показатели в статистике процесса. По умолчанию статистика выводится по первой привязанной к процессу очереди.
