...
1. Для бизнес-процессов, к которым привязаны несколько очередей, появилась возможность выводить комбинированную статистику. Для этого в рассчитанных эффектах появилось поле **Ops_total** - в данном поле вы можете указать формулу с перечислением необходимых очередей для вывода комбинированных показателей в статистике процесса.
