...
Обновили внешний вид дашбордов и упростили их создание: Новые дашборды накликиваются пользователями. 1. Разработали новый интерфейс - метрики отображаются в более понятном и приятном виде. Пока только на главной странице, но потихоньку будем внедрять и на другие блоки. 

(приложить скрин главной страницы)

19498 (Дашборд новый) - Переделали дашборды. Они стали проще. дашборды есть только на главной странице. Считается, что 1 стр = 1 дашборд. 
...
Реализовали? -нужно учесть, что могут быть созданы дашборды, которые должны вести расчёт только для связанных с ним департаментов. А связанные с дашбордом департаменты, зависят от от связанных с пользователем департаментов. Т.е. действительный контекст дашборда, зависит от того, кто на него смотрит.


Кроме того должна быть возможность обратиться к общему списку процессов (не ограниченных данным департаментом). Поэтому должен быть доступ к общему списку процессов и их данным.
