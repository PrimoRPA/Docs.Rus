...
1. Инструмент [пропустить элемент](https://docs.primo-rpa.ru/primo-rpa/primo-studio/process/debug#propusk-elementa) не работал в режиме запуска проекта, только при отладке. Теперь пропускать выбранные элементы можно в обоих режимах.
...
1. Исправлена ошибка, связанная с невозможностью очистить индекс в шаблоне поиска для браузерных приложений. 
1. В разделе **О программе** не отображался срок истечения оркестраторной лицензии Студии. Ошибка исправлена.

1. Отсутствовала проверка синтаксиса в объявлениях переменных и аргументов, на предмет доступности ссылок на модули в DataType https://dev.azure.com/primorpa/Primo/_queries/edit/939/?triage=true
