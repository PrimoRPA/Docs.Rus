...
NuGet-пакет **Primo.Art.Linux** предназначен для управления транзакцией и сбора статистики выполнения процессов.
 ...
 * [Primo.Art 1.0.2](https://docs.primo-rpa.ru/primo-rpa/release-notes/packages/linux/primo-art/1.0.2)
