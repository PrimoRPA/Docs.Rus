...
2. Для заданий с запуском по расписанию добавлено отображение "Следующей даты по расписанию" сразу после создания задания. Ранее значение отображалось только после первого запуска задания.
...
4. Оптимизирована работа с RPA-проектами: больше не проверяется наличие файлов проекта на диске, поскольку файлы хранятся в БД.
