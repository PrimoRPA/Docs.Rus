...
### Новые функции
1. Оптимизирована работа экземпляров Оркестратора при развертывании в одном кластере. Теперь в момент запуска им будет назначаться свой диапазон уникальных идентификаторов (id) сущностей из базы данных. Это ускоряет опрос роботов, машин роботов и мониторинг RDP-сессий со стороны Оркестратора.
