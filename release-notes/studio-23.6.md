...
1. При попытке открыть удаленный проект из меню **Файл > Проект > Недавние** (история открытия проектов) происходило зависание Студии. Ошибка исправлена, теперь при аналогичной попытке выводится сообщение о некорректном пути к файлу, после чего работа Студии не нарушается.
