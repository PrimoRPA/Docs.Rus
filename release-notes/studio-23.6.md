...
... в онли код элементе.. - там не останавливалась отладка, даже если процесс онли код был открыт. 

1. 1621 - Робот не обрабатывает повторные элементы очереди. (Миша). Сережа Самсонов проапдейтил. Починили. Уточнить про тестирование у Саши Менялина. Подробности у Киреева уточнить, он знает.
