...
1. Название корневого контейнера **Последовательность** теперь соответствовует имени процесса, указанному при создании процесса. 
...
1. Лучше стал определяться селектор на кнопках десктоп-приложений **TWR ITC**. Инструмент теперь осуществляет надежный поиск элементов в иерархии, также улучшено восстановление исходного форматирования текста.
...
1. Добавлен элемент **Удаление писем**, который используется для удаления почтовых сообщений по протоколу **IMAP**.
