...
1. Отмена последних действий с элементом, который был вырезан/вставлен/перенесен в другое место, стала работать корректно. Оптимизировано количество пользовательских действий для отмены изменений.
