...
1. Оптимизировано количество пользовательских действий для отмены последних изменений, связанных с элементом, который был вырезан/вставлен/перенесен в другое место. 
