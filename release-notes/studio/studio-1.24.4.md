...
1. В процессах с типом **Последовательность** появилась возможность выделять сразу несколько элементов, используя `Shift` + клик мышью на первом и последнем элементе. - добавить гифку
