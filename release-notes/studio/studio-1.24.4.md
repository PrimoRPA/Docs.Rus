...
1. Расширены возможности возможности работы с JSON. Стала поддерживаться автоматическая десериализация не только в тип `Dictionary`, но и в различные типы коллекций, включая `List<T>`.
