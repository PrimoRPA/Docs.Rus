...
1. Устранена причина аварийного завершения работы Студии при повторных попытках открыть большие ltw-файлы проекта (более 1000 элементов). 
1. Сокращено время открытия больших файлов процесса, а также объем занимаемой оперативной памяти.
...
1. Исправлена ошибка в работе элемента "Присоединиться к приложению", которая возникала при выборе различных типов автоматизации. Ошибка воспроизводилась при вложенном элементе первого поколения.
