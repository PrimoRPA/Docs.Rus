...
1. Добавлена функциональность в **Pick branch** (Pick branch), позволяющая задать действие по умолчанию для ситуаций, когда не срабатывает ни один из условных ветвей Pick branch.
