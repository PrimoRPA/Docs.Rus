...
2. Добавлен элемент **Установить пароль** (SetPassword) для установки пароля на Excel файлы.
...
6. Добавлена кнопка **Приостановить отладку**. Позволяет приостановить отладку для процессов с типом **Диаграмма** и **Чистый код**. Функция выполняет ту же роль, что приостановка отладки для последовательности.
...
8. Улучшена работа Студии при использовании `Selenium WebDriver`.
...
13. Улучшена работа элемента **C# Script**:
   - Добавлена валидация свойства `Сценарий`.
