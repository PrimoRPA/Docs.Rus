...
1. Добавлен элемент **Установить пароль** (SetPassword) для установки пароля на Excel файлы.
...
1. Улучшена работа элемента **C# Script**:
...
1.  Добавлено предупреждение при несовпадении типа переменной с типом входных данных в элементе **Присвоение** (Assign).
