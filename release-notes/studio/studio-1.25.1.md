...
1. Исправлена ошибка в элементе **«Функция BAPI»**, из-за которой параметры из входного поля «Options» не использовались, что приводило к выполнению без параметров. Теперь параметры «Options» корректно учитываются.
