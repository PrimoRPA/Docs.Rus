...
1. Добавлена возможность отображения часто используемых свойств напрямую на элементе. Введённые данные в параметрах активности автоматически синхронизируются с соответствующими свойствами элемента в правой части окна. По умолчанию функция отключена. 
   ...
   В этом же окне встроен **редактор синтаксиса** (IntelliSense), который поддерживает:
	- Подсказки и автозаполнение методов.
	- Работу с программными выражениями.

   Функция доступна в тестовом режиме для групп элементов **Рабочий стол**,**Работа с UI**и др. Планируется расширение на другие группы в будущих релизах.
