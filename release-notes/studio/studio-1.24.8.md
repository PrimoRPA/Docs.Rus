...
1. Добавлены новые активности для управления вкладками браузера: 
   -  [**Активировать вкладку (ActivateTab)**](https://docs.primo-rpa.ru/primo-rpa/g_elements/el_basic/els_browser/el_activatetab) (активация вкладки по индексу, идентификатору, заголовку и/или URL), 
