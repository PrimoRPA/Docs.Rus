...
1. В панели **Наблюдение (Watch)** добавлена возможность выполнения C# кода в командной строке **"Немедленно" (Immediate)** во время работы проекта, что позволяет тестировать части кода и работать с переменными в реальном времени.
