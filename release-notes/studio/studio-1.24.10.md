...
Информацию по обновленным релизам версии 1.24.10 можно найти в разделах:
  ...
  *  [Студия 1.24.10.5](https://docs.primo-rpa.ru/primo-rpa/release-notes/studio/studio-1.24.10/studio-1.24.10.5)
...
В элементе присутствуют параметры, которые позволяют гибко настраивать область поиска элементов. Для использования данной функции потребуется обновление расширения браузера до версии 3.72(1.72)
...
В элементах Citizen удалена кнопка `Пропуск элемента`.

## Актуализация расширения браузера

:white_check_mark: Для использования данной версии Студии требуется обновление расширения браузера до версии 3.72(1.72)
