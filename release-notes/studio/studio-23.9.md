...
1. Изменился интерфейс редактора шаблона поиска и выбора шаблона (селектора). Новый дизайн интерфейса, расширен функционал:
   * в готовом редакторе шаблона можно вывести дерево элемента управления. из дерева можно выбрать сразу свойство.
   * в окне выборе шаблона можно редактировать значения.
