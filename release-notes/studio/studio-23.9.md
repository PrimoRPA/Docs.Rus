...
1. Значительно улучшен UI/UX **Редактора шаблона**:
   ...
   * В окне выбора свойств также добавлены подсказки, помогающие скорректировать шаблон. Кроме этого стало возможно редактировать значения свойств прямо в редакторе.
