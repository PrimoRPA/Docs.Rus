...
1. Улучшен внешний вид **Редактора шаблона** и логика его работы (UX).

   ![](<../../.gitbook/assets/new-template-editor.png>)
   
   * Добавилась возможность отобразить дерево компонентов. И-и-и.... что  с ним можно сделать? + Дерево возможно обновлять
   * Валидация настроек шаблона - вместо "отобразить компонент" ранее? зачем изменили?
   * Выбор элемента на экране - вместо волшебной палочки ранее?


   * Улучшен инструмент **Выбор элемента** (Picker) - появились подсказки с описанием горячих клавиш...
  
     ![](<../../.gitbook/assets/picker-3.png>)
   
   * Валидация - по кнопке. Запуск и проверка текущих настроек поиска и выбора элемента управления.
   * Подсказки при формировании шаблона
   * Возможность редактировать значения свойств элемента управления прямо в редакторе
   * Выбор нового элемента через дерево
