...
1. Значительно улучшен UI/UX **Редактора шаблона**:
   ...
   * В окне выбора свойств также добавлены подсказки, помогающие скорректировать шаблон. Кроме этого стало возможным редактировать значения свойств прямо в редакторе.
