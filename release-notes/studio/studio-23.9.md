...
1. Значительно улучшен UI/UX **Редактора шаблона поиска**:
   ...
   * В окне редактора шаблона добавилась опция **Путь до элемента**, позволяющая управлять родительскими и дочерними селекторами при помощи команд контекстного меню.
