...
1. Значительно улучшен UI/UX **Редактора шаблона поиска**. Изменения призваны сделать сделать его более удобным и понятным в использовании. Подробности см. в разделе [Новый редактор шаблон поиска]().
