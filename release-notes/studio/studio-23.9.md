...
1. Исправлено некорректное поведение индикатора ошибки, которое наблюдалось после удаления из проекта зависимости. Индикатор отображался на элементах, не связанных с удалённой зависимостью. 
