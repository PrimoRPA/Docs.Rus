...
1. Исправлена ошибка, связанная с работой элемента [Уничтожить процесс](https://docs.primo-rpa.ru/primo-rpa/g_elements/osnovnye-elementy/els_desktop/el_desktop_kill). Процесс не уничтожался, если его имя было указано с расширением. Теперь при указании в имени процесса расширения (например, "Excel.exe"), он также будет уничтожен.
