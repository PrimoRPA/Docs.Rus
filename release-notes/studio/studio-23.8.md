...
1. 3286 (Назаренко) -  Исправлена утечка памяти, возникавшая из-за переоткрытия вкладок процессов в Студии. В результате утечки процесс Primo.Studio.exe мог занять значительный объем оперативной памяти в случае продолжительной работы. Теперь при закрытии вкладок оперативная память стала освобождаться.
