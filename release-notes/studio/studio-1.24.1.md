...
1. Исправлена ошибка, связанная с некорректным свойством ContainerID у вложенного элемента. Ошибка могла возникать при перетаскивании элемента с шаблоном из одного контейнера в другой. 
