...
1. У элемента [**Открыть браузер**](https://docs.primo-rpa.ru/primo-rpa/g_elements/el_basic/els_browser/el_browser_open) появилось свойство **Состояние загрузки**. Теперь возможно определить ожидаемый статус загрузки веб-страницы, указанной в контейнере. Переход к первому элементу контейнера будет осуществляться только при указанном состоянии загрузки. Если страница не загрузится в установленный таймаут, возникнет ошибка. Доступные значения:
