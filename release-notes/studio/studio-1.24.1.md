...
1. Улучшен выбор тестовых данных для RPA-проектов. Теперь при создании процесса возможно указать рабочий лист файла с тестовыми данными, а также конкрентные строки и столбцы листа.
...
1. 3231	Доработка функционала студии для тестовых кейсов						Alexey Khonin


1. 10338	После Активности throw робот не может продолжить за рамками ltw в котором это произошло		Alexandr Kazeko
