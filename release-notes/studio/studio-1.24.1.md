...
1. Не работает клик по первому элементу.



1. 7717	Привести к единому виду название кнопок в окне редактора шаблона.
1. 7658	В редакторе шаблона, при смене текущего селектора на новый, происходит удаление.
1. 7659	В редакторе шаблона, не удаляется селектор или появляется ошибка и Студия зависает.
