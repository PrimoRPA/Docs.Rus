...
2. Перебор строк Excel.
3. Исправлена ошибка, из-за которой в некоторых случаях:
  * не открывалось контекстное меню элементов;
  * контекстное меню открывалось, но невозможно было выбрать его команду.
4. Исправлена некорректная работа команды контекстного меню **Закомментировать элементы**.
5. Подсказки в свойствах элементов не работают.
6. Некорректная работа активности **Прочитать таблицу**.
7. Настройка активностей **Ответить на письмо / Переслать письмо**.
