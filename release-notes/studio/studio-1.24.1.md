...
1. Исправлена ошибка в **Чтении диапазона** (Excel) с включенным чекбоксом **Учитывать типы полей ячеек Excel** и драйвером Interop. Она возникала, если первая ячейка диапазона была пустой.
