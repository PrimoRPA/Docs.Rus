...
1. Исправлен сброс параметров в шаблоне поиска, если элемент с шаблоном был перемещен или скопирован в контейнер.
1. Исправлена ошибка, когда попытка перевыбрать элемент управления в выпадающем списке не приводила к обновлению селектора.
