...
1. Исправлена ошибка в шаблоне поиска, связанная с некорректным свойством ContainerID у вложенного элемента. Ошибка могла возникать при перетаскивании элемента с шаблоном из одного контейнера в другой. 
1. Исправлен сброс настроек в шаблоне поиска, если элемент с шаблоном был перемешен или скопирован в контейнер.
