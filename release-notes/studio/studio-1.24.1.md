...
Ниже описаны изменения для издания Primo RPA Studio с выбранным режимом работы **Pro**.
...
1. Реализована библиотека **Primo.Collections**. Она добавляет 4 новых элемента в группу Данные > Таблицы:
   * **Построить таблицу** - создает таблицу на основе данных, указанных в Мастере. Результат сохраняет в переменную типа DataTable.
   * **Соединить таблицы** - .
   * **Получить значение** - .
   * **Изменить значение** - .
...
### Другое
1. Исправлена ошибка аргументов SQL при обработке через цикл.
