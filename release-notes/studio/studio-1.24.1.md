...
1. Исправлена ошибка в **Чтении диапазона** (Excel) с включенным чекбоксом **Учитывать типы полей ячеек Excel** и драйвером Interop. Диапазон не считывался, если первая его ячейка была пустой.
