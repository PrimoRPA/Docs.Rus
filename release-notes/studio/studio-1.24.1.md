...
1. Появилась возможность закомментировать **Последовательность** не верхнего уровня, используя пункт контекстного меню. 
...
1. Исправлена ошибка в методах обращения к Оркестратору, которые использует робот при работе с ресурсами (assets). 


### UI
1. В панели "Элементы" некорректно отображаются папки с элементами зависимостей. 
