...
2. При создании переменной система стала валидировать значение по умолчанию, если пользователь указал массив. Если массив задан неверно, система отобразит ошибку.
3. 
