...
Ниже описаны изменения для издания Primo RPA Studio Enterprise.
...
2. При создании переменной система стала валидировать значение по умолчанию, если в нем указан массив.
3. 
