...
1. Перебор строк Excel.
1. Некорректная работа активности **Прочитать таблицу**.
1. Настройка активностей **Ответить на письмо / Переслать письмо**.
1. Исправлена ошибка, из-за которой в некоторых случаях:
