...
## Изменения и улучшения (Studio Enterprise)
...
1. Появилась возможность закомментировать элемент **Последовательность**, используя пункт контекстного меню. 
...
### Элементы
1. ///(статус под вопросом) Исправлено некорректное поведение элементов в пакете [Primo.Office.MyOffice](https://www.nuget.org/packages?q=Primo.Office.MyOffice), версия пакета обновлена до 1.0.2. 
...
Важно: во второй версии нельзя использовать неициализированные переменные, иначе отладчик работать не будет.
