...
1. Исправлена ошибка в шаблоне поиска, связанная с некорректным свойством ContainerID у вложенного элемента. Ошибка могла возникать при переносе элемента с шаблоном из одного контейнера в другой. 
