...
1. Исправлена работа функции «Путь до элемента» в редакторе шаблона поиска. Путь до элемента теперь динамически изменяется, если пользователь вносит корректировки в параметры шаблона.



1. 7345	Проблема нового селектора при работе с приложением Java						Mikhail Bogdan
1. 7717	Привести к единому виду название кнопок в окне редактора шаблона				Mikhail Bogdan
1. 7798	Не работает клик по первому элементу								Mikhail Bogdan
1. 7658	В редакторе шаблона, при смене текущего селектора на новый, происходит удаление... 		Alexey Perkin
1. 7659	В редакторе шаблона, не удаляется селектор или появляется ошибка и Студия зависает		Mikhail Stabredov
