...
1. Устранена ошибка в работе событий, которая возникала при установке параллельного режима в контейнере **События** и присвоении переменных в параллельных потоках. Ошибка приводила к внеплановому завершению работы робота. 
