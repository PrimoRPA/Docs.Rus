...
* Работать с элементом **Запустить приложение** стала удобнее:
  * Ранее исполняемый файл приходилось указывать текстом, теперь появилась возможность выбрать его в Проводнике Windows.
  * Поле **Аргументы** перенесено в свойства.
* Перебор строк excel 
...
1. Появился плагин для интеграции с GigaChat и YandexGPT - `Primo.AI.Plugin.dll`. Он позволяет активировать поддержку чата AI в разделе настроек **[Интеграция > AI](https://docs.primo-rpa.ru/primo-rpa/primo-studio/settings#integraciya)**. Если соответствующих настройки указаны, в меню отобразится кнопка **AI запрос** для общения с выбранной нейросетью. Кнопка запроса доступна также в редакторе кода.
