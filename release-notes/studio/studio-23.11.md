...
1. Реализован **LTools.Office.SDK** - набор инструментов и компонентов, предоставляющих доступ к функциональности таких приложений Microsoft Office, как Excel, Word, Outlook и Exchange. Описание работы с **LTools.Office.SDK** см. [здесь](https://docs.primo-rpa.ru/primo-rpa/developers/sdk).
