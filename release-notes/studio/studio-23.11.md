...
1. Для элементов добавлены команды контекстного меню:
   ...
   * **Извлечь элемент из try/catch** - извлекает выделенный элемент или элементы из **Try-Cath**.

  ![](<../../.gitbook/assets1/move-element-to-try-catch.png>)

2. В Robot Runner добавлена информация о версии Runner'a, которую можно найти в разделе меню **Файл > О программе**. https://azure-dos.s1.primo1.orch/PrimoCollection/Studio/_boards/board/t/Studio%20Team/Stories/?workitem=3253
...
1. https://azure-dos.s1.primo1.orch/PrimoCollection/Studio/_boards/board/t/Studio%20Team/Stories/?workitem=737
   Не переключалась раскладка.
Не работает активность по смене раскладки языка на английский.
