...
1. Реализован **LTools.Office.SDK** - набор инструментов для разработчиков, предоставляющий доступ к функциональности приложений Microsoft Office. Таких, как Excel, Word, Outlook и Exchange. Использование **LTools.Office.SDK** позволяет разработать свои элементы Primo для автоматизации работы с перечисленными программами. Описание работы с **LTools.Office.SDK** см. [здесь](https://docs.primo-rpa.ru/primo-rpa/developers/sdk).
...
1. Для элементов [**Получить письма (IMAP)**](https://docs.primo-rpa.ru/primo-rpa/g_elements/el_basic/els_mail/imap_getmail) и [**Переместить в папку (IMAP)**](https://docs.primo-rpa.ru/primo-rpa/g_elements/el_basic/els_mail/imap_movetofolder) добавлены свойства:
   ...
   * **SSO** - способ указания шифрования, которое должно использоваться для соединения. Значение учитывается, если включен параметр **Использовать SSO**. В этом случае при подключении к почтовому серверу будет использовано SSO и проигнорировано свойство SSL. 

   ![](<../../.gitbook/assets1/sso-property-in-imap-mail.png>)
