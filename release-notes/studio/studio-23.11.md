...
1. Реализован **LTools.Office.SDK** - набор инструментов и компонентов, которые предоставляют доступ к функциональности приложений Microsoft Office. Таких, как Excel, Word, Outlook и Exchange. Описание работы с **LTools.Office.SDK** см. [здесь](https://docs.primo-rpa.ru/primo-rpa/developers/sdk).
