...
1. Реализован набор инструментов для разработчиков **LTools.Office.SDK**. С его помощью можно разработать свои элементы Primo для автоматизации работы с программами MS Office: Excel, Word, Outlook и Exchange. Описание работы с **LTools.Office.SDK** см. [здесь](https://docs.primo-rpa.ru/primo-rpa/developers/sdk).
