...
1. Устранена проблема, когда не работали элементы **Получить письма (IMAP)** и **Переместить в папку (IMAP)** с указанным портом 143 и снятой галочкой в свойстве `SSL`. Для этого свойства данных элементов были доработаны (см. пункт 7 в «Новых функциях»).
