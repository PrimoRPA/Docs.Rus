...
1. Добавлена возможность переключения между старым и новым редактором шаблона поиска (селектора). По умолчанию в Студии используется обновленный редактор. Чтобы изменить значение:
   ...
   * Либо используйте команду контекстного меню **Открыть старый/новый редактор шаблона** (значение зависит от редактора по умолчанию). Она добавлена для всех элементов, содержащих свойство **Шаблон поиска**. Смена редактора таким способом не меняет редактор по умолчанию и не очищает ранее заполненные свойства шаблона.
