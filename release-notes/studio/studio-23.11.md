...
Auto, Ssl On Connect, Start Tlc, Start Tlc When Available
...
1. Устранена проблема, когда не работали элементы **Получить письма (IMAP)** и **Переместить в папку (IMAP)** с указанным портом 143 и снятой галочкой в свойстве `SSL`. 
