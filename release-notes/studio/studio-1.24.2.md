...
## Fix 1.24.2.6 (режим Pro)
1. Исправлена ошибка с сохранением ComponentId элемента и точек останова при перетаскивании/вырезании/копировании/вставке элемента в процессе. 
2. Исправлены ошибки, возникавшие при перетаскивании элементов в **Try-Catch** / **Закомментировать** либо при их извлечении из этих контейнеров. А именно:
   * Устранены изменения ComponentID элемента, в том числе ComponentID вложенных элементов, при перетаскивании элемента/контейнера в последовательности и помещении в **Try-Catch** / **Закомментировать**.
   * Устранена потеря точек останова и установленных пропусков элемента при перетаскивании и копировании элемента/контейнера. В том числе во вложенных элементах. 
   * Исправлено некорректное поведение Студии при одновременном оборачивании нескольких элементов в **Try-Catch** / **Закомментировать** или одновременном перетаскивании в последовательности.
   * Исправлены наиболее частые причины изменения стрелок в диаграмме.

## Fix 1.24.2.7 (режим Pro)
1. Исправлена ошибка в работе элемента **Ссылка на процесс** в цикле.
2. Исправлена ошибка в работе элемента **Ссылка на процесс** из **Try-Catch**.
3. Обновлено название и описание шаблонов проекта.
