...
1. Обновлен шаблон проектов (ReFramework). Демонстрационный проект доступен на [Learning](https://github.com/PrimoRPA/Learning/tree/master) — см. папку **StudioTemplatesProjectExample**.
