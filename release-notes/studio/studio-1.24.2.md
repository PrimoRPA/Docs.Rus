...
2. Исправлены ошибки, возникавшие при перетаскивании элементов в **Try-Catch** / **Закомментировать** либо при их извлечении. А именно:
   ...
   * Исправлено некорректное поведение Студии при одновременном переносе нескольких элементов в **Try-Catch** / **Закомментировать** или одновременном перетаскивании в последовательности.
