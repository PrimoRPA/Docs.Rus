...
2. Исправлены ошибки, возникавшие при перетаскивании элементов в **Try-Catch** / **Закомментировать** либо при их извлечении. А именно:
   ...
   * Стали сохраняться точки останова и пропуски элементов при перетаскивании и копировании элемента/контейнера. В том числе во вложенных элементах. 
