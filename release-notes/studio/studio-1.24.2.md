...
2. Исправлены ошибки, возникавшие при перетаскивании элементов в **Try-Catch** / **Закомментировать** либо при их извлечении. А именно:
   * Перестал изменяться ComponentID элемента, в том числе ComponentID вложенных элементов, при перетаскивании элемента/контейнера в последовательности и помещении в **Try-Catch** / **Закомментировать**.
   * Стали сохраняться точки останова и установленные пропуски элементов при перетаскивании и копировании элемента/контейнера. В том числе во вложенных элементах. 
