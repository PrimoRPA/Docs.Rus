...
1. Опубликована библиотека [**Primo.Collections**](https://docs.primo-rpa.ru/g_elements/el_extra/els_collections) для автоматизации действий с таблицами. Библиотека добавляет набор элементов в группу **Данные > Таблицы**, а именно:
...
Учли пожелания пользователей при работе с шаблоном проекта. Внесены следующие изменения:
...
[Шаблоны проекта](https://docs.primo-rpa.ru/primo-rpa/primo-studio/projects/project_template) доступны в разделе меню **Файл ➝ Проект**:
...
1. ..Вернуть функционал ручной корректировки селектора
...
1. Решена проблема с переносом элементов и точек останова при перетаскивании/вырезании/копировании/вставке в диаграммах. 
