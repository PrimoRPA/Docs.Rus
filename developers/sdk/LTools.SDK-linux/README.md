...
4. Далее выберите фреймворк **.NET 8.0** и нажмите **Создать**.

   ![](<../../../.gitbook/assets1/net8-for-linux-sdk.png>)

5. В меню Visual Studio выберите **Проект > Добавить ссылку на проект**.
6. В открывшемся окне нажмите кнопку **Обзор...** и откройте каталог установки Primo RPA Studio под Linux. Добавьте из каталога в свой проект следующие файлы:
   * LTools.Common.dll
   * LTools.Dto.dll
   * LTools.Enums.dll
