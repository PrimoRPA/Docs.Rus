...
Впоследствии вы можете установить ваш NuGet-пакет в Primo RPA Studio на Linux, чтобы добавить элемент в среду разработки.
...
Прижите данные к UI. Для изменения значения вашего свойства в визуальной части элемента используйте Binding.
...
В панели **Обозреватель решений** вызовите контекстное меню решения и выберите **Собрать решение**. В результате сборки будет получена библиотека `Primo.*.dll`.
