...
:large_orange_diamond:***Важно**. До версии Primo RPA Studio 1.24.8 в проектах использовалась платформа .NET 6.0 и Avalonia 0.10. Если вы уже разрабатывали проекты с этими характеристиками, вам потребуется обновить проекты в Visual Studio, иначе они не будут работать с Primo RPA Studio 1.24.8 и выше.*
...
4. Далее выберите платформу **.NET 8.0** и нажмите **Создать**.
   ...
   ![](<../../../.gitbook/assets1/net8-for-linux-sdk.png>)
