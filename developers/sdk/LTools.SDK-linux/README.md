...
3. Views — визуальные формы элементов.
4. Images — иконки будущих элементов.  - //только иконки или еще что-то? Какие форматы изображений разрешены (только png?)? Есть ли рекомендуемые размеры и ограничения?
5. Localization — файлы локализации при необходимости.
