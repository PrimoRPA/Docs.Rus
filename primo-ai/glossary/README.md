...
Модель — математическая структура, обученная на основе данных для решения конкретных задач. В контексте Primo RPA AI Server модель решает задачу детекции объектов — анализирует изображения, чтобы обнаружить, классифицировать и локализовать объекты. 
