...
Датасет — набор изображений, используемый для обучения и тестирования модели нейронной сети. Датасет обычно состоит из изображений и аннотаций, описывающих местоположение и классы объектов (поля в документах) на изображениях. В сервисе используются обучающий и тестовый датасеты. 
...
Тестирование — этап проверки качества модели на отдельном наборе данных, который не использовался для обучения. Такой набор данных называется тестовым датасетом. Тестирование помогает оценить обобщающую способность модели и выявить переобучение.
