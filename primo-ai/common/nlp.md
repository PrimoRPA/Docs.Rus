...
AI Server поставляется с набором предустановленных навыков, которые вы можете использовать в базовой конфигурации или корректировать при помощи примеров входных и выходных данных (файла контекста). Предустановленные навыки перечислены ниже.
...
**Экстракция**. Модель извлекает из текста информацию по заданным ключам поиска. Ищите ключевые данные в отчетах, договорах, заявках для быстрой оценки ситуации или выявления распространенных проблем.
