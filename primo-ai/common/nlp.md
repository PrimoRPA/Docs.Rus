...
AI Server поставляется с набором предустановленных навыков, которые вы можете использовать в базовой конфигурации или корректировать при помощи примеров входных и выходных данных (файла контекста). 
