...
По умолчанию в систему уже добавлены пользователи со встроенной ролью Administrator — это пользователи **superadmin** и **admin**. Пользователи с данными учетными записями настраивают систему для использования рядовыми пользователями. 
