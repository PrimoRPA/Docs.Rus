...
Встроенные учетные записи с административными полномочиями представлены в таблице ниже. С помощью данных пользователей вы можете настроить сервис для рядовых пользователей. 
