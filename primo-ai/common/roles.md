...
По умолчанию в систему уже добавлены пользователи со встроенной ролью Administrator — это пользователи **superadmin** и **admin**. С помощью данных пользователей вы можете настроить сервис для рядовых пользователей. 
