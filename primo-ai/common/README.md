...
**Primo RPA AI Server** — сервис, который позволяет использовать возможности искусственного интеллекта для обработки и распознавания документов. Пользователь может самостоятельно обучать и улучшать модели нейронной сети, чтобы затем использовать готовые решения в RPA-проектах в Primo RPA Studio. 
