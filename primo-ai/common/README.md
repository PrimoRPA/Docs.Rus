...
**Primo RPA AI Server** — автоматизированная информационная система (далее — система), которая позволяет использовать возможности искусственного интеллекта для обработки и распознавания документов. Пользователь может самостоятельно обучать модели нейронной сети и затем использовать их в своих RPA-проектах в Primo RPA Studio. Модели можно постоянно улучшать до достижения оптимального уровня распознавания.
