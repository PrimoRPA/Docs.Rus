...
**Primo RPA AI Server** — автоматизированная информационная система (далее — система), которая позволяет использовать возможности искусственного интеллекта и OCR для обработки и распознавания документов. Пользователь может самостоятельно обучать модели нейронной сети, подготавливать машину к процессу распознавания новых данных и влиять на качество результата. 
