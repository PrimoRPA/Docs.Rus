...
**Primo RPA AI Server** — сервис, который позволяет использовать возможности искусственного интеллекта для обработки и распознавания документов. Благодаря сервису пользователь может самостоятельно обучать модели нейронной сети, чтобы затем использовать готовые решения в RPA-проектах в Primo RPA Studio. 
