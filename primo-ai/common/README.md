...
* масштабирует работу с распознаванием документов за счет настраиваемого количества целевых машин;
