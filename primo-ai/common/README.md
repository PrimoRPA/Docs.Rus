...
**Primo RPA AI Server** — автоматизированная информационная система (далее — система), которая позволяет использовать возможности искусственного интеллекта и OCR для распознавания и обработки документов. Пользователь Primo RPA AI Server может самостоятельно обучать модели нейронной сети для распознавания документов, запускать процесс распознавания и влиять на качество результата. 
