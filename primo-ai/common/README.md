...
**Primo RPA AI Server** — автоматизированная информационная система (далее — система), которая позволяет использовать возможности искусственного интеллекта и OCR для обработки и распознавания документов. Пользователь может самостоятельно обучать модели нейронной сети, настраивать машину для процесса распознавания новых данных и влиять на качество результата. 
...
Primo RPA AI Server является коммерческим решением и требует заключения лицензионного договора на использование. При наличии действующего договора вы можете получить лицензию. Запрос на лицензию формируется средствами веб-интерфеса — подробнее о том, как это сделать, см. [здесь]().
