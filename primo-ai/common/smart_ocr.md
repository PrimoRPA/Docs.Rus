...
1. Использование модели для решения реальных задач.
...
1. На стороне AI Server — запустите процесс инференса на целевой машине с компонентом Умный OCR.
1. Отправьте запрос к серверу
