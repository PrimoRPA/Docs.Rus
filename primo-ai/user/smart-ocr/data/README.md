...
Данные — изображения документов, которые будут использоваться для обучения вашей модели. Из данных формируются датасеты для тренировки модели (обучающий датасет) и оценки ее способностей детектировать объекты на изображении (тестовый датасет). 
