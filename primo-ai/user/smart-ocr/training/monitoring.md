...
1. **Ошибка на обучающем наборе данных (Total Loss, синяя кривая):**
...
2. **Средняя точность на тестовом наборе данных (Average Precision, красная кривая):**
...
3. **Коэффициент обучения (Learning Rate, зеленая кривая):**
...
![Пример неудачного обучения модели](<../../../../primo-ai/resources/user/smartocr/example-unsuccessful-model-training.png>)
