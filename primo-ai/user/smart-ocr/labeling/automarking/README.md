...
1. На панели инструментов выберите **Автоматическую разметка**, чтобы перейти на страницу **Шаблоны автоматической разметки**. Кнопка становится активной, только если есть размеченные изображения.
