...
1. Когда процесс обучения завершился, откроейте меню действий процесса и выберите пункт **Применить разметку**. 
...
Если после применения авторазметки вы добавили новые изображения, то либо разметьте их вручную, либо заново обучите модель для возможности применить к новым изображениям авторазметку.
