...
В функциональном блоке **Схема** разверните список значений. Если он пуст, нажмите кнопку **Создать схему**. Схема определяет, какие поля должна находить модель на изображениях. 
...
Вы можете разметить только ~10% изображений, а для оставшейся части использовать [авторазметку](https://docs.primo-rpa.ru/primo-rpa/primo-rpa-ai-server/user/smart-ocr/labeling/automarking), чтобы сократить время ручного труда.
