...
Для выполнения перечисленных действий воспользуйтесь учетной записью администратора либо записью пользователя, для роли которого назначены следующие минимальные права:
