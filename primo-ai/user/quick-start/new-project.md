...
:large_blue_diamond:***Примечание**. Роль пользователя должна иметь права «Процессы обучения — Создание, Просмотр».*
...
:large_blue_diamond:***Примечание**. Роль пользователя должна иметь права «Процессы обучения — Просмотр, Управление».*
