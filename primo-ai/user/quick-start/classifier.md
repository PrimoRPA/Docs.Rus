...
1. Справа, в блоке «Датасет», выберите тип датасета «Обучение» и нажмите кнопку **Сохранить разметку**.

   ![](<../../../.gitbook/assets1/primo-ai/classifier-9-2.png>)

1. Перейдите к следующему изображению:
...
1. Оставьте примерно 10-20% изображений для тестового датасета.
