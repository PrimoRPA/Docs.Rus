...
Данная модель будет полезна, если пользователь хранит смешанные изображения документов и хочет распределить их по типам. Обученная модель должна определять 3 типа документов: паспорт, СНИЛС, Торг-12.
