...
Данная модель будет полезна, если пользователь хранит смешанные изображения документов и хочет распределить их по типам перед тем, как начать распознавать данные в каждом из документов. 

Обученная модель должна определять 3 типа документов: паспорт, СНИЛС, Торг-12.
