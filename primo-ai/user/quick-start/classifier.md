...
Система позволяет отслеживать качество обучения модели:

1. Выберите для вашего запущенного процесса действие **Мониторинг обучения**.
...
Обученная модель представляет собой архив с .pth-файлом модели, а также её метаданными – файл config.yaml.
