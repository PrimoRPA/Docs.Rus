...
В данном разделе вы узнаете, как пошагово обучить модель-классификатор на примере встроенного проекта «Классификатор». 
...
В систему уже встроен проект «Классификатор», который позволяет быстро начать работу с интересующей моделью. Данная статья содержит пошаговую инструкцию по работе с проектом «Классификатор».
...
1. Выберите для вашего процесса инференса действие **Запустить**.
   ...
   ![](<../../../.gitbook/assets1/primo-ai/class-run-infprocess.png>)
