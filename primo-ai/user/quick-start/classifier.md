...
Ожидаемый результат — обученная модель должна уметь определять 3 типа документов: 
* паспорт;
* СНИЛС;
* Торг-12.

#### 2. Настройка и запуск инференса на целевой машине

Ожидаемый результат — подготовлена машина для распознавания реальных изображений документов.
Обученная модель должна уметь определять 3 типа документов: 
* паспорт;
* СНИЛС;
* Торг-12.
