...
В данном разделе вы узнаете, как работать со встроенным проектом Classifier. Проект предназначен для разпознавания типа входящего документа и полезен, если пользователь имеет смешанные изображения документов и хочет отсортировать их по типам.
...
2. Перейдите в раздел с вашим проектом.
