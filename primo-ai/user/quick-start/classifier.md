...
Выберите тип поля в соответствии с текущим изображением документа. Например, если вы начали работу с изображением документа Торг-12, то в панели справа тоже выберите поле torg-12.

![](<../../../.gitbook/assets1/primo-ai/classifier-7-new.png>)

Выберите в верхней панели инструмент **Add Bounding Box (b)**.

![](<../../../.gitbook/assets1/primo-ai/classifier-8.png>)

Выделите инструментом **Add Bounding Box (b)** значимую часть документа — область с данными. На рисунке ниже область с данными выделена пунктирной линией.
