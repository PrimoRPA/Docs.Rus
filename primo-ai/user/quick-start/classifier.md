...
1. В соответствии с вашим рабочим изображением выберите тип поля. Например, если вы работаете с Торг-12, то выберите поле torg-12.
1. Выберите в верхней панели инструмент **Add Bounding Box (b)**.
1. Выделите значимую часть документа (область с данными) иструментом. 
