...
Оставьте примерно 10-20% изображений для тестового датасета. Укажите для них правильные поля, выделите область с данными инструментом **Add Bounding Box (b)**, но при сохранении разметки укажите датасет «Тестовый».
