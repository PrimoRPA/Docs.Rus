...
Получить одну или несколько целевых машин, подготовленных для выполнения инференса — использования обученной модели для классификации новых, ранее не виденных изображений документов. 
...
Если все шаги пройдены корректно, то в результате вы получите целевую машину, подготовленную для принятия и обработки изображений моделью-классификатором. Время, в течение которого машина будет готова к инференсу, не ограничено. К машине, на которой запущен процесс инференса, теперь могут обращаться роботы, выполняющие RPA-проект по классификации документов.
