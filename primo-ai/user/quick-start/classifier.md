...
1. **Обучение модели-классификатора.** Ожидаемый результат — наличие обученной модели.
2. **Настройка и запуск инференса на целевой машине.** Ожидаемый результат — наличие подготовленной машины, на которой будет выполняться распознавание изображений документов по их типам.
