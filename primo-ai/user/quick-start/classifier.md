...
Данная модель будет полезна, если пользователь хранит смешанные изображения документов и хочет распределить их по типам перед тем, как начать распознавать данные в определенном типе документов. 
