...
На этом работа с проектом в интерфейсе Primo RPA AI Server может быть окончена. Если все шаги пройдены корректно, то вы получите целевую машину, подготовленную для принятия и обработки изображений обученной моделью. Время, в течение которого машина будет готова к инференсу, не ограничено. 

Если у вас большой объемом документов для инференса и имеются дополнительные целевые машины, то вы можете создать еще несколько процессов инференса в текущем шаблоне, чтобы горизонтально масштабировать работу и уменьшить время, затраченное на инференс.
