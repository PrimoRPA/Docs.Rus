...
1. Укажите положение параметров-переключателей:
   ...
   * **Вычитание из текста наименований полей** — переведите переключатель вправо, если из документов для инференса следует ....может попасть внутрь bounding box фрагмент название поля. Этот фрагмент будет вычитаться из наименования.
   * **Парсинг заголовка таблицы** — переведите переключатель вправо, если в документах для инференса, содержащих таблицы, не нужно распознавать заголовки столбцов. По умолчанию заголовки распознаются.
