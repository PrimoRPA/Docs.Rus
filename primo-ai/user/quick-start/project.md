...
1. Укажите положение параметров-переключателей:
   ...
   * **Вычитание из текста наименований полей** — переведите переключатель вправо, если из распознанных значений следует удалять фрагменты названий полей. ....может попасть внутрь bounding box фрагмент название поля. Этот фрагмент будет вычитаться из наименования.
