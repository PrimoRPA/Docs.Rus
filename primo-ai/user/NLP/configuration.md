...
Область для конфигурации будущей модели на основе базовой модели и настроек ее LLM-движка. 
...
После выбора ключа в конфигурацию автоматически загрузится файл контекста — это встроенный json-файл, который определяет поведение модели. Файл контекста помогает улучшать качество ответов модели и генерировать более релевантные и точные ответы. 
