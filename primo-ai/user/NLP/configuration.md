...
Цель выполнения настроек — запустить сервер с большой языковой моделью, которая готова обрабатывать NLP-запросы. Спектр решаемых задач определяется сконфигурированными навыками модели. 
...
* `2` — Область выбора целевых машин для запуска LLM-модели. 
