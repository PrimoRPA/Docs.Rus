...
Создайте проеет с типом **NLP-задачи**.

## Конфигурация

После создания проекта автоматически открывается страница настройки. Также на нее можно перейти позже, если выбрать на главной странице карточку вашего NLP-проекта.
