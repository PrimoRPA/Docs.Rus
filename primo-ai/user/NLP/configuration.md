...
**Предварительные условия**. Создайте проект с типом **NLP-задачи**. 
...
Перейдите на вкладку тестирование, чтобы проверить качество ответов модели, или сразу используйте модель посредством роботов или API.
