...
Страница **Тестирование** становится доступной после запуска модели на целевой машине — в этом случае модель готова принимать запросы и генерировать ответы в соответствии с навыком и задачей.
