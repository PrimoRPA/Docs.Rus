...
На рисунке выше отмечены следующие элементы рабочей области:
* `1` — Область настройки LLM-модели. Это первый и обязательный шаг — каждую модель следует сконфигурировать до запуска на целевых машинах. 
