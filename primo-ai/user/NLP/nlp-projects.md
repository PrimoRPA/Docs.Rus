...
Предназначена для тестирования указанных навыков NLP-модели. Рабочая область состоит из двух областей:
* Запрос — содержит параметры запроса.
* Ответ — ответ на запрос от NLP-модели.

### Запрос

1. **Текст для обработки\*** —
1. **Ключи ответа\*** —
1. **Ключ маршрутизации\*** —
1. **Длина ответа\*** — по умолчанию `256`.
