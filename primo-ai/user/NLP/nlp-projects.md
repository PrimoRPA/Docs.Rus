...
Цель выполнения всех настроек — получить модель, готовую принимать NLP-запросы. Задачи, которые может решать модель, ограничиваются навыками, которые вы выбираете в ходе настройки. 
