...
После того, как модель станет готова принимать запросы, вы можете воспользоваться вкладкой **Тестирование** (цифра на рисунке). Вкладка позволяет отправлять запросы и получать ответ от модели, не выходя из проекта — 
