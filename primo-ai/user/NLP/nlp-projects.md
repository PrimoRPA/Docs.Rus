...
{% hint style="warning" %}
Если в списке целевых машин нет нужного значения, убедитесь, что целевая машина была создана администратором на вкладке **Настройки > Целевые машины**, а также включена и доступна.
{% endhint %}
