...
1. Убедитесь, что модель успешно запустилась на машине — напротив всех стадий запуска должна стоять галочка. Финальный статус запуска — `Готова принимать запросы`.
