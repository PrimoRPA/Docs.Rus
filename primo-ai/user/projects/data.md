...
После того, как вы добавили изображения в проект, требуется создать схему разметки изображений. 
...
1. Выберите карточку проекта, после чего перейдите на страницу **Данные**.
