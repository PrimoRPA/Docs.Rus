...
Добавленный архив отобразится на странице с архивами проекта. Чтобы его увидеть, нажмите кнопку **Архивы**.

![](<../../../.gitbook/assets1/primo-ai/user-guide/data-button-archives.png>)

Архив, который вы загрузили, автоматически распакуется через несколько секунд. **Изображения из архива появятся ГДЕ?**
