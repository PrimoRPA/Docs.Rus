...
Таким образом, поле «Фамилия» или «Дата рождения» в паспорте будет являться категорией информации, которую необходимо извлечь и структурировать для дальнейшего использования моделью распознавания данных. Таким образом, при создании схемы разметки данных в паспорте каждое поле будет представлять собой отдельный элемент информации, который нужно извлечь из документа.
