...
Вы можете пропустить шаг создания схемы и сразу перейти в раздел разметки изображений. Это возможно, поскольку на странице **Разметка изображений** также существует инструмент по созданию схемы. Таким образом, вы можете создать схему и сразу разметить поля на изображениях в одном месте.
