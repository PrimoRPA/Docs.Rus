...
Вы можете пропустить шаг создания схемы разметки и сразу перейти в раздел разметки изображений. Это допускается, поскольку на странице **Разметка изображений** также существует инструмент по созданию схемы.
