...
Пользователь может создать схему разметки, редактировать и удалить из проекта. Кроме этого, в созданную схему разметки можно добавить поля (метки), редактировать их и удалять из схемы.
