...
Панель инструментов для работы с изображением. Слева направо:
* **Select (v)** — позволяет выбрать размеченное поле.
* **Drag/Pan (right or middle click) (d)** — позволяет перетащить изображение в пределах рабочей области.
* **Zoom In/Out (scroll)  (z)** —
* **Add Bounding Box (b)** —
* **Fit to screen (f)** —
* **Rotate image (r)** —
...
Возможные действия:
* Здесь схему можно создать;
* выбрать схему, если она уже создана;
* добавить в схему новые поля. 

#### 3 — функциональный блок для работы со схемой разметки

#### 4 — функциональный блок для работы со схемой разметки

#### 5 — функциональный блок для работы со схемой разметки
