...
3. Выделите инструментом **Add Bounding Box (b)** значимую часть документа — область с данными. На рисунке ниже область с данными отображается пунктирной линией.
...
5. Перейдите к следующему изображению вашей галереи:
