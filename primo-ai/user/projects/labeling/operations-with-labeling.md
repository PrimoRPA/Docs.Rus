...
* Выбрать схему разметки, если вы ее заранее создали;
...
Регион представляет собой сохраненную размеченную область. Новый регион появится в данном блоке после того, как:
1. Вы выбрали поле.
