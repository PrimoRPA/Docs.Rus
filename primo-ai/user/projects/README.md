...
Общие действия с проектом описаны [здесь](https://docs.primo-rpa.ru/primo-rpa/primo-rpa-ai-server/user/projects/operations-with-project). К ним относятся возможности создания, просмотра, редактирования, удаления проекта, вне зависимости от его типа.
