...
Если вы хотите обрабатывать изображения документов, выбирайте проекты типа **Умный OCR**. Анализ изображений осуществляется с помощью сверточных моделей. Различные типы моделей могут:
