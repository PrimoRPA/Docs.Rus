...
Проект — объект сервиса Server AI, с помощью которого вы можете управлять различными типами моделей, ресурсами проекта и запуском моделей на целевых машинах.
