...
Проект используется для работы со сверточными моделями, которые анализируют изображения документов и могут:
...
Структура проекта содержит страницы для управления ресурсами. Перейдите в проект, чтобы увидеть их — меню управления ресурсами отобразится слева. 
