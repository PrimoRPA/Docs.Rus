...
Чтобы перейти к процессам обучения, выберите в меню проекта раздел **Обучение**, далее — вкладку **Шаблоны обучения**, после чего примените действие **Процессы** для имеющегося шаблона.

![](<../../../../.gitbook/assets1/primo-ai//user-guide/go-to-training-process.gif>)

## Возможные действия с процессом
* создать — позволяет добавить процесс обучения в шаблон. 
