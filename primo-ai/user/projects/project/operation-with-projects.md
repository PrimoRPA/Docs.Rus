...
1. При желании в поле **Описание проекта** добавьте краткое описание. Оно отобразится в интерфейсе под названием проекта и поможет быстрее понять его назначение другим пользователям.
