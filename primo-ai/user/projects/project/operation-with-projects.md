...
1. При желании в поле **Описание** кратко опишите назначение проекта. Оно отобразится в интерфейсе под названием проекта и поможет быстрее понять его назначение другим пользователям.
