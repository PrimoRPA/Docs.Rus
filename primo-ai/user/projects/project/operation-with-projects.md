...
1. При желании в поле **Описание проекта** укажите назначение проекта. Оно отобразится в интерфейсе под названием проекта и поможет быстрее понять его назначение другим пользователям.
