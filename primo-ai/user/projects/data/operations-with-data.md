...
:large_blue_diamond:***Примечание**. Роль пользователя должна включать право «Проект — Просмотр, Создание, Редактирование».*
...
## Удалить изображение
:large_blue_diamond:***Примечание**. Роль пользователя должна включать право «Проект — Удаление».*
