...
Данный запрос отправляет робот при выполнении RPA-проекта с элементом [Создать запрос](https://docs.primo-rpa.ru/primo-rpa/g_elements/el_extra/ai_server/createrequest). Запрос подразумевает обработку одного изображения, поданного на вход модели, с целью извлечь из него данные.
