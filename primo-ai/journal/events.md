...
| 21901 | AutoMarkingProcessStopedSuccess                   | Процесс автоматической разметки успешно остановлен  |
| 21902 | AutoMarkingProcessStopedError                     | Процесс автоматической разметки **не** удалось остановить. Например, когда процесс уже был остановлен, или когда недоступен агент, или когда не хватает прав доступа |
...
### Шаблон процесса инференса (Умный OCR)
...
### NLP-запрос 
Данные события фиксируют обработку тестовых NLP-запросов на вкладке "Тестирование" в NLP-проекте или через сервис Api.Inference.
