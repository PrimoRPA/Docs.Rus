...
### Шаблон процесса инференса (общие для NLP и OCR)

В NLP под шаблоном инференса подразумевается конфигурация (вкладка "Настройка" в NLP-проекте).
...
В NLP под процессом инференса подразумевается процесс запуска модели на целевой машине.
