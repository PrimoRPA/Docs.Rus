...
| 604   | LicenseRevoked                            | Лицензия отозвана. **Примечание:** в текущей версии отзыв лицензии не реализован | 
| 605   | LicenseRevokeReplaced                     | **Отозванная лицензия заменена**. **Примечание:** в текущей версии замена лицензии не реализована  | 
| 606   | LicenseRequested                          | Лицензия запрошена                | 
| 607   | LicenseReplaceRequested                   | **Замена лицензии запрошена**. **Примечание:** в текущей версии замена лицензии не реализована | 
...
| 2003  | LoginUserLocked                           | Пользователь заблокирован (**или это попытка входа заблокированного пользователя?**). Вход заблокированного пользователя временно ограничен. При попытке входа такой пользователь увидит уведомление `Ошибка аутентификации` | 
| 2004  | LoginUserUnauthorized                     | Пользователь не авторизован **требуются пояснения, почему** | 
| 2005  | LoginUserUnauthorizedAD                   | AD-пользователь не авторизован. **Примечание**: в текущей версии AD-пользователи не используются |  
...
| 8003  | RoleAssignAdGroups                        | Роль привязана к AD-группе. *В текущей версии сервиса AD-группы не используются* |    
