...
| 2003  | LoginUserLocked                           | **Попытка входа заблокированного пользователя**. Вход заблокированного пользователя временно ограничен. При попытке входа такой пользователь увидит уведомление `Ошибка аутентификации` | 
