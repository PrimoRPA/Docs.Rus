...
В данном разделе приводятся все события, которые фиксируются в Primo RPA AI Server. Список событий может измениться в следующих версиях Primo RPA AI Server.
...
Данные события фиксируют информацию о типах моделей и ключах маршрутизации.
...
### Запрос на извлечение данных/инференс (Умный OCR)

Запрос подразумевает обработку одного изображения документа с целью извлечь из него данные.
...
### NLP-запрос 
Данные события фиксируют обработку NLP-запросов на вкладке "Тестирование" в NLP-проекте или через сервис Api.Inference.
...
Данные события фиксируют изменения, произведенные пользователем на вкладке "Настройки" в проекте NLP.
...
| 22018 | NlpTaskAttachingSucceed                           | Успешная передача навыка работающей модели  |
| 22019 | NlpTaskAttachingFailed                            | Ошибка передачи навыка |
| 22020 | NlpTaskDetachingStart                             | Непосредственно перед изъятием навыка у работающей модели целевой машины |
| 22028 | NlpTaskDetachingSucceed                           | Успешное изъятие навыка работающей модели  |
| 22029 | NlpTaskDetachingFailed                            | Ошибка изъятия навыка |
