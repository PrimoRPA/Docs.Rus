...
В ответе придет файл лицензионного ключа с расширением `*.license`, который необходимо загрузить в систему. По умолчанию лицензия считается выданной на дефолтный тенант. После того, как вы загрузите лицензию в сервис, можно будет указать для нее другой тенант — см. [Выдать лицензию на тенант](https://docs.primo-rpa.ru/primo-rpa/primo-rpa-ai-server/admin/licenses/license-management#vydat-licenziyu-na-tenant).
