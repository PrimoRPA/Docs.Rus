...
В ответе придет файл лицензионного ключа с расширением `*.license`, который необходимо загрузить в систему. По умолчанию лицензия считается выданной на дефолтный тенант. После того, как вы загрузите лицензию в сервис, можно будет указать для нее другой тенант — см. [Выдать лицензию на тенант]().
...
В случае, если лицензию требуется использовать для недефолтного тенанта, вы можете вручную указать тенант для загруженной лицензии. Лицензии между тенантами не делятся, у каждого тенанта свои лицензии.
