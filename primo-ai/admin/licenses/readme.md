...
Это означает, что для работы с сервисом необходимо запросить у вендора необходимое количество лицензий на оба продукта. Лицензии вправе запросить только администратор с ролью  .... на странице **Настройки > Лицензии**. 
