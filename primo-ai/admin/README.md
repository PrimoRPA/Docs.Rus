...
Цель администратора — подготовить систему, предварительно развернутую ответственными специалистами, для работы пользователей с ограниченными правами. Чтобы эти пользователи могли создавать свои проекты, обучать модели и распознавать данные.
