...
По умолчанию все целевые машины создаются со статусом `Включена` — это означает, что если если конфигурационный файл агента настроен корректно и машина доступна, то ...

 пользователь сможет запускать на ней процессы инференса/обучения модели в проекте *Умный OCR*, или запускать модель в проекте *NLP* — в зависимости от того, под какие задачи настроена физическая/виртуальная машина.
