...
2. Заполните обязательные параметры:
   ...
   * *Логин* — введите логин пользователя. Логин должен состоять только из букв, цифр, символов '_' и '-' и точки.
   ...
   * *Имя* — укажите имя пользователя. Имя должно состоять только из букв, цифр, символов '_' и '-' и точки.
