...
Для корректной работы также требуются сервисные учетные записи, которые обеспечивают взаимодействие между компонентами системы. Встроенные сервисные пользователи представлены в таблице ниже. Данные учетные записи кросстенантны.
