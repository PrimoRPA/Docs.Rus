...
Управление доступом осуществляется на основе ролей. Каждому пользователю должна быть назначена роль, определяющая набор разрешенных действий, которые становятся доступными после входа в систему.
