...
5. Выберите права пользователя в разрезе объектов системы, которые будут определять набор доступных действий по отношению к указанным объектам. Доступные права:
   ...
   * *Управление* — операция доступна по отношению к ограниченному количеству сущностей системы. А именно:
     * управление агентами — полные права на управление сущностью агента (просмотр, создание, редактирование, удаление агентов), а также возможности блокировки и разблокировки агентов.
     * управление процессами инференса — полные права на управление процессами инференса (просмотр, создание, удаление процессов), а также возможности запуска, останова, включения, выключения процессов.
     * управление процессами обучения — полные права на управление процессами обучения модели (просмотр, создание, удаление процессов), а также возможности запуска, останова, включения, выключения процессов.
     * управление паплайнами — в настоящей версии паплайны не используются.
6. Нажмите **Сохранить**.
