...
Упрощенный способ создания типа модели, который не затрагивает настройки в блоке **Конфигурация**:
...
Выше описан упрощенный способ создания типа модели, который не затрагивает настройки в блоке **Конфигурация**. Этот блок содержит список технических параметров, который имеет стандартную настройку и будет использован при создании в проекте шаблона инференса с указанным типом модели. Конфигурацию в шаблоне инференса можно будет изменить.

Если вы изменить конфигурацию по умолчанию, то разверните блок **Конфигурация**: (**СВЕРНУТЬ ГИТБУКОМ ЭТОТ БЛОК**)
