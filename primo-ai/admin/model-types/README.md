...
Перечисленные типы моделей используются во встроенных проектах, доступных на главной странице. Модели, используемые во встроенных проектах, уже прошли обучение на оптимальной выборке данных. Чтобы начать работу со встроенными типами моделей, просто перейдите в соответствующий проект на главной странице. 
...
Если встроенных типов моделей недостаточно, то имеется возможность добавить в систему свой тип модели. Например, вы хотите распознавать другой тип документа, для которого нет подходящего типа модели среди предустановленных.

Управление типами моделей осуществляется на странице **Настройки ➝ Типы моделей**. Администратор может добавить тип модели, изменить, удалить из системы.
