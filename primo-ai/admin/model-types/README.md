...
Эти типы моделей используются во встроенных проектах и уже обучены на выборке данных. Чтобы начать работу с этими типами моделей, просто перейдите в соответствующий проект. 
