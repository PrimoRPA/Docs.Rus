...
Если встроенных типов моделей недостаточно, то имеется возможность добавить в систему свой тип модели. Например, вы хотите распознавать другой тип документа, для которого еще не создан тип модели.
