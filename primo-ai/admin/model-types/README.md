...
Тип модели — это модель или группа моделей, объединенные общей целью. Например, к типу модели `passport` относятся модели, которые распознают данные в изображениях паспортов.
