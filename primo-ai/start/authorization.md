...
1. По логину и паролю пользователя Primo AI. Это учетная запись, информация о которой хранится в БД Primo AI.
2. По логину и паролю учетной записи Active Directory. Этот способ использует технологию единого входа (SSO). Администратор системы должен выполнить предварительные настройки на стороне Primo AI.
