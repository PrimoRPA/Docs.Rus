...
1. Серверы хранилищ данных:
   * PostgreSQL / MS SQL - обязательный компонент. Это сервер с основыми БД, хранящими информацию о настройках Primo.AI, пользователях, ролях, лицензий, событий и др.
