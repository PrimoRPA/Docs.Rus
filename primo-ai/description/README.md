...
Primo AI является коммерческим решением и требует заключения контракта для его использования. При наличии действующего контракта возможно получить лицензию. Для получения лицензии администратор системы должен сформировать запрос через веб-интерфейс Primo AI и отправить его на email вендора. Подробнее о том, как это сделать, см. здесь.
