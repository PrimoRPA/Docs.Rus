...
1. Серверы баз данных:
    1.1. Сервер с PostgreSQL/MS SQL - обязательный компонент. Это сервер с основными БД, хранящими информацию о настройках Primo.AI, пользователях, ролях, лицензий, событий и др.
    1.2. Сервер с Minio - объектное хранилище для изображений, использующихся при обучении модели и распознавании данных. 
    1.3. Сервер с Redis - базы данных класса NoSQL, хранящие данные типа «ключ — значение». Предназначены для временного хранения токенов авторизации и результатов инференсов.
