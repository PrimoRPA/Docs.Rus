...
| Параметр        | Машина с Logics-сервером    | Машина с LLM-ядром 'Llama.cpp'  | Машина с LLM-ядром 'vllm' (без GPU) | Машина с LLM-ядром 'vllm' (с GPU) | 
| --------------- | --------------------------- |-------------------------------- | ----------------------------------- | --------------------------------- |
| CPU | 4 физических ядра / 8 виртуальных ядер | 6 физических / 12 виртуальных ядер (AVX2+) | 16 физических / 32 виртуальных ядра (AVX2+) | 8 физических / 16 виртуальных ядра |
| RAM | 8 Гб	                                 | 32 Гб	                                    | 32 Гб	                                      | 32 Гб	                             | 
| HDD | 50 Гб (OS + Data)	                     | 250 Гб (OS + Data)	                        | 250 Гб (OS + Data)	                        | 250 Гб (OS + Data)	               |
