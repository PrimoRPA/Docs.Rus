# Предварительная настройка машины Primo RPA AI Server под Astra Linux

На машине для Primo RPA AI Server должна быть установлена Astra Linux. После установки ОС выполните предварительную настройку машины согласно шагам ниже.
