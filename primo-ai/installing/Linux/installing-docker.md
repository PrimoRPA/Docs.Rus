...
{% hint style="warning" %}
**Примечание**. Проверьте зависимости устанавливаемого пакета iptables версии 1.8.5-3~bpo10+1+b1_amd64. Используйте входящий в комплект поставки пакет только на чистой и поддерживаемой версии ОС. В остальных случаях установите пакет iptables вручную.
{% endhint %}
