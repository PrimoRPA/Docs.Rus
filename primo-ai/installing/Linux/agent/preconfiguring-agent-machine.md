...
Создайте учетную запись **idp**, указав расположение home-папки – там будут размещены инсталляции Python, а также все необходимые пакеты суммарным весом более 3.5 Гбайт:
```
