...
Выберите подходящий вариант установки и скопируйте на целевую машину указанные файлы из комплекта поставки Primo RPA AI Server. Остальное ПО должно быть предустановлено в Astra Linux.
...
Требуется интернет и менеджер пакетов apt с конкретными зависимостями в репозиториях.
...
Используется при невозможности выполнить вариант установки A и B. Подходит для версии Astra Linux Special Edition 1.7 (базовой) amd64. Это единственный вариант установки, который не требует менеджера пакетов apt с репозиториями.
