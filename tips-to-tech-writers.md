...
1. **Правила написания** классические - придерживаемся инфостиля. Избегаем оценочных слов, излишних канцеляризмов, пытаемся сформулировать мысль чище и короче. Например, вместо "необходимо нажать" - "нажмите". И т.д.
   ...
   Кавычки. Вместо кавычек я часто использую **просто жирное выделение**. Но иногда текст может выглядет перегруженным, поэтому это не железное правило, и можно применять кавычки. С ними правило простое: используем елочки («текст»), если это не пример кода. 
