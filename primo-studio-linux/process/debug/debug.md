...
1. **Запустить процесс** ![](<../../../.gitbook/assets1/Debug-StartProcess.PNG>) — при выполнении операции проигнорируются [точки останова](https://docs.primo-rpa.ru/primo-rpa/primo-studio-linux/process/debug#tochka-ostanova) ![](<../../../.gitbook/assets1/Debug-Breakpoint.PNG>) и [пропуск элементов](https://docs.primo-rpa.ru/primo-rpa/primo-studio-linux/process/debug#propusk-elementa) ![](../../../.gitbook/assets1/Debug-SkipElement.PNG). Процесс выполнится быстрее, чем при отладке, но в журнал запишется меньше логов. 
2. **Отладить процесс** ![](<../../../.gitbook/assets1/Debug-Debug.PNG>) — операция поддерживает все установленные на элементах точки останова и пропуски. Во время отладки будет выведена наиболее полная информация о действиях робота. 
...
![](../../../.gitbook/Debug-ConsoleFilters.PNG)

Над ними расположены кнопки:

* ![](<../../../.gitbook/assets1/Debug-FollowConsole.PNG>) **Следовать за наполнением консоли** — текст консоли будет всегда фокусироваться на последнем полученном сообщении.
* ![](<../../../.gitbook/assets1/Debug-ClearConsole.PNG>) **Очистить консоль** — очищает содержимое консоли.
...
![](<../../../.gitbook/Debug-RunFromElement.png>)
