...
Возобновить процесс с того места, где возникла ошибка, можно при помощи кнопки **Сделать шаг** <img src="../../../.gitbook/assets1/Debug-TakeAStep.PNG" alt="" data-size="line"> или **Возобновить процесс** <img src="../../../.gitbook/assets1/Debug-ResumeProcess.PNG" alt="" data-size="line">.
...
Кнопка **Приостановить отладку** для всех типов процессов позволяет останавливать выполнение процесса в нужный момент, что улучшает контроль за его исполнением.
