...
С версии 1.24.10 в панели Наблюдение (Watch) теперь поддерживается выполнение C# кода, что позволяет разработчикам тестировать код и работать с переменными в памяти без необходимости полного запуска проекта.
