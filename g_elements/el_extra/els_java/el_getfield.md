...
| Тип                  | String                | Укажите пакет и класс Java, который содержит поле. Значение должно иметь вид: `"package.name.ClassName"`. Если задан тип, свойство **Объект** заполнять не нужно |
| ***Вывод***     | |  |
