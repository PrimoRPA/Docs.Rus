...
## Свойства
Символ `*` в названии свойства указывает на обязательность его заполнения. В нашем случае, кроме названия поля, потребуется также указать либо объект Java, либо тип (имя класса).
