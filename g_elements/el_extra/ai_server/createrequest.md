...
2. **Тип модели** *[String]* — название типа модели для распознавания документа. Должно совпадать с названием типа в Primo RPA AI Server, регистр важен. Пример: `"Classifier"`.
