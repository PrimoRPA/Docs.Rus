...
1. Перед использованием элемента **Получить результат NLP** создайте запрос NLP к Primo AI Server и сохраните идентификатор запроса в переменную — он понадобится для получения ответа.
