...
Элемент **Создать чат** становится доступным после установки библиотеки **Primo.AI**. Найти его можно на панели элементов в группе YandexGPT:
...
1. **ID папки\*** *[String]* - идентификатор папки в Yandex Cloud. Значение указывается в виде переменной или константы. 
