...
Библиотека **Primo.Collections** позволяет автоматизировать работу с таблицами. В библиотеку входят следующие элементы:
...
Перечисленные элементы станут доступными после установки библиотеки. Найти их можно на панели элементов в группе **Данные > Таблицы**. 
