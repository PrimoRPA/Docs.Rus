...
Обучающий проект, демонстрирующий пример использования **Эмуляции спецкнопки** вместе с другими элементами, можно найти на [Learning](https://github.com/PrimoRPA/Learning). Скачайте проект StudioActivities, откройте его в Студии и найдите процесс StudioActivities > Ru > Рабочий стол > Эмуляция спецкнопки.ltw.
