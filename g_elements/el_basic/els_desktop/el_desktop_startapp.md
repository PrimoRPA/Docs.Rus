...
После успешного запуска приложения, к нему можно подключиться через контейнер [Присоединиться к приложению](https://docs.primo-rpa.ru/primo-rpa/g_elements/el_basic/els_desktop/el_desktop_attach), чтобы стали доступными действия с элементами интерфейса.
