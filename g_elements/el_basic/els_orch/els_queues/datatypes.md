...
| RetryCount  | Int32                                                           | Возвращает количество повторов элемента. Извлеченный из очереди элемент может быть добавлен в очередь повторно в ответ на возникновение ошибки. Допустимость повторов определяется настройкой очереди |
