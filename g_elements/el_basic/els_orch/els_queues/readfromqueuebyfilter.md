...
1. **Получать тэги** *[Boolean]* — Получать тэги элемента. Если параметр включен, тэги элемента будут извлечены из данных очереди Оркестратора. **Функция доступна с версии 1.24.10.**
