...
| Фильтр     | String | Фильтр по метаданным в виде [регулярного выражения для SQL](https://postgrespro.ru/docs/postgresql/15/functions-matching). Обратите внимание, что Regexp используется в PostgreSQL, если Оркестратор установлен с MS SQL SERVER, то регулярные выражения не применимы, используются конструкции с оператором LIKE  | "%1330\|15.07.2022%"
