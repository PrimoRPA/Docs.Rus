...
:bangbang: ***Для корректной работы обязательно заполните свойства:***
1. **«Очередь»**.
2. **«Значение»** либо **«Таблица»**. В случае, если заполнены оба свойства - «Значение» и «Таблица» - запишутся данные только из таблицы.

| Свойство        |                                                                    Тип                                                                   | Описание                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
| --------------- | :--------------------------------------------------------------------------------------------------------------------------------------: | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| _**Процесс:**_   |                                                                                                                                          |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
| Очередь\*       |                                                                  String                                                                  | Название очереди, в которую нужно добавить элемент очереди (транзакцию). Название должно совпадать с именем очереди в Оркестраторе. Чувствительно к регистру!                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
