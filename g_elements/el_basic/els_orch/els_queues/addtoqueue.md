...
:bangbang: **Важно.** Для корректной работы обязательно нужно заполнить свойства **Очередь** и **Значение** (либо **Таблица**). В случае, если заполнены оба свойства - _Значение_ и _Таблица_ - в данные будет записана только таблица. 
