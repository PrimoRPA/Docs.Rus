...
С помощью элемента[^1] робот может получить [ресурс (asset)](https://docs.primo-rpa.ru/primo-rpa/orchestrator/basics/assets) из Оркестратора. Доступен ресурс с любым типом данных, заданным на стороне Оркестратора. А именно:
* String
* Integer
* Floating
* Boolean
...
:heavy_check_mark: Успешно установлена связь Студии и Оркестратора. О том, как это сделать, см. [здесь](https://docs.primo-rpa.ru/primo-rpa/primo-studio/settings#orkestrator).\
