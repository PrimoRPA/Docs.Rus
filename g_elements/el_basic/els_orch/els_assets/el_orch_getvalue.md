...
Позволяет получить [ресурс](https://docs.primo-rpa.ru/primo-rpa/orchestrator/basics/assets) (asset) из Оркестратора. Робот получает ресурс с любым типом данных, заданным на стороне Оркестратора. А именно:
* String
* Integer
* Floating
* Boolean
...
Полученный ресурс необходимо сохранить в виде переменной в свойстве **Результат**. Переменная имеет тип данных System.Object.
...
| -------------- | ------ | ---------------------------------------------------------------------------------------------------------------------------------------------------- |
| Наименование\* | String | Имя переменной (ресурса) из Оркестратора, значение которой вы хотите получить. Пример: `"My asset"` |
...
| Результат      | Object | Имя переменной, которая будет хранить полученное значение ресурса             |
