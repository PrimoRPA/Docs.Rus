...
Производит установку значения в Оркестратор. Под значением подразумевается новый [ресурс](https://docs.primo-rpa.ru/primo-rpa/orchestrator/basics/assets) (asset), который необходимо создать в Оркестраторе. 
