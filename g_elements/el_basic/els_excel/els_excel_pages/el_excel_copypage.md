...
| Файл*              | String     | Если страницу нужно вставить во внешний файл Excel, укажите к нему путь. Если путь не задан, страница будет вставлена (скопирована) внутри файла-источника. Пример значения: `"C:\path\to\file.xlsx"` |
