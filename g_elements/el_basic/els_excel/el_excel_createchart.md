...
| Страница             | String   | Название страницы в книге Excel, в которую вы хотите добавить диаграмму         | `"List1"`  |
...
3. Описание процессов можно найти в файлах проекта. Процессы проекта имеют тип **Последовательность**.
