...
:small_blue_diamond: ***Совет***. *Чтобы в файле сохранились изменения, используйте элемент [Сохранить документ](https://docs.primo-rpa.ru/primo-rpa/g_elements/el_basic/els_excel/el_excel_save).*
