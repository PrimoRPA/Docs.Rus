...
> :small_blue_diamond: **Совет**. Чтобы изменения в файле применились, используйте также элемент [Сохранить документ](https://docs.primo-rpa.ru/primo-rpa/g_elements/el_basic/els_excel/el_excel_save).
