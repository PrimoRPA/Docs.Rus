...
![Элемент «Ввод формулы в ячейку»](<../../../.gitbook/assets1/WFWriteCellFormula.png>)
...
| Индекс страницы | Int32  | Порядковый номер страницы. Нумерация начинается с нуля. Если указан индекс, то страница может быть переименована | `0` |
