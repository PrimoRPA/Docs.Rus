...
1. **Драйвер** *[LTools.Office.Model.InteropTypes]* — тип драйвера подключения. Драйвер определяет особенности работы с файлом. Щелкните выпадающий список значений, чтобы выбрать тип: DX или Interop. По умолчанию используется DX (DevExpress).\
   \
