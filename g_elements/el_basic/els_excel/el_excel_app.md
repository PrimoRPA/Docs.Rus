...
Ниже приведено описание утилитарных свойств элемента. Описание общих свойств см. в разделе [**Работа с элементами**_](https://docs.primo-rpa.ru/primo-rpa/primo-studio/process/elements).
