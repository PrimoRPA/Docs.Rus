...
1. **Драйвер** [LTools.Office.Model.InteropTypes] — тип драйвера подключения. Определяет особенности работы с файлом. Щелкните выпадающий список значений, чтобы выбрать драйвер: DX или Interop. По умолчанию установлен DX (DevExpress).
...
3. **Пароль** [String] — пароль для открытия [защищенного](https://support.microsoft.com/ru-ru/office/%D0%B7%D0%B0%D1%89%D0%B8%D1%82%D0%B0-%D1%84%D0%B0%D0%B9%D0%BB%D0%B0-excel-7359d4ae-7213-4ac2-b058-f75e9311b599) файла Excel.
...
5. **Проверять файл** [Boolean] — установка чекбокса запускает проверку на наличие указанного файла Excel. Если проверка выявит, что файл отсутствует, то:
