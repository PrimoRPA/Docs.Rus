...
| Путь к файлу           | String                                                                                                 | <p>Путь к файлу документа Excel. Пример: <code>@"C:\folder\file.xlsx"</code>.</p><p>Символ @ используется для экранирования обратного слеша <code>\</code></p> |
