...
| Открывать только на чтение | Boolean                                                                      | Только для Interop. Определяет, нужно ли открывать указанный файл только для чтения. По умолчанию не установлен. **Ограничения:** если включено свойство **Присоединяться**, то установка этого параметра будет проигнорирована. Настройка также будет проигнорирована, если указан массив байтов или используется файл в формате текста с разделителями |
