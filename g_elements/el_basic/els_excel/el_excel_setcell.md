...
Если при выполнении элемента вы получили ошибку *"Нулевой объект должен иметь значение"*, убедитесь, что в свойствах **Цвет бордюра**, **Цвет ячеек** установлено необходимое значение. В случае, если вам не нужно использовать определенный цвет, установите значение `null`.
