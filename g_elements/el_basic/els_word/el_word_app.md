...
| Пароль (зашифрованный) | SecureString             | Зашифрованный пароль от документа. В целях безопасности пароль в формате SecureString не хранится в открытом виде. Получить его можно, например, из программы «Диспетчер учетных данных» (Credential Manager), после чего вставить в это поле. *Доступно с версии 1.23.7* |
|**Word** |  |
