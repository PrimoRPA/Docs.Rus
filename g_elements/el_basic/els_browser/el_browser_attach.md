...
| Индекс вкладки браузера | Int32                              | Индекс вкладки браузера. **Свойство доступно с версии 24.8.**      |
...
| Освобождать        | Bool                                | Определяет, нужно ли освобождать ссылку на браузер при выходе                                   |
...
![Индекс вкладки браузера](<../../../.gitbook/assets1/Index_vkl_br.png>)
