...
### HTML
Группа активностей **Данные > HTML** может использоваться в бизнес-процессах, направленных на работу с HTML-кодом. Например, такой код может прийти в теле письма. Или может понадобиться извлечь данные из HTML-кода сайта и обработать их.
