...
Элемент прозводит клик мышью на указанном тексте. Текст определяется относительно [элемента управления](https://learn.microsoft.com/ru-ru/windows/apps/design/controls/) в приложении рабочего стола. 
