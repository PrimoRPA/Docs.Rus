...
Например, при определении шаблона поиска волшебной палочкой будет автоматически сделан скриншот найденного элемента управления. Этот скриншот поможет быстрее понять, какой элемент требовалось найти для клика мышью. 
