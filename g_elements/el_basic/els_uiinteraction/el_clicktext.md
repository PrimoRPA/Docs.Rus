...
![](<../../../.gitbook/assets/ocr-text-screenshot1-3.png>)

Скриншоты элемента сохраняются в папку проекта `.Resources`, название скриншота содержит ID элемента, к которому относится изображение.
