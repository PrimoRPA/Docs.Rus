...
1. **Диапазон\*** *[String]*: Диапазон ячеек для сортировки (A1:D12). Если значение не указано, будет отсортирован выделенный диапазон. Если диапазон не выделен, будет отсортирован весь лист.
