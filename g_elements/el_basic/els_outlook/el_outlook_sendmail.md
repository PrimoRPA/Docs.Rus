...
10. **От имени (адрес)** *[String]* - заполняется в случае необходимости изменить отправителя сообщения. В значении необходимо указать почту конкретного отправителя либо [общий ящик](https://support.microsoft.com/ru-ru/office/%D0%BE%D1%82%D0%BA%D1%80%D1%8B%D1%82%D0%B8%D0%B5-%D0%B8-%D0%B8%D1%81%D0%BF%D0%BE%D0%BB%D1%8C%D0%B7%D0%BE%D0%B2%D0%B0%D0%BD%D0%B8%D0%B5-%D0%BE%D0%B1%D1%89%D0%B5%D0%B3%D0%BE-%D0%BF%D0%BE%D1%87%D1%82%D0%BE%D0%B2%D0%BE%D0%B3%D0%BE-%D1%8F%D1%89%D0%B8%D0%BA%D0%B0-%D0%B2-outlook-d94a8e9e-21f1-4240-808b-de9c9c088afd), участником которого вы являетесь. Если не заполнено, то по умолчанию письмо будет отправлено от имени владельца аккаунта.
...
1. При выполнении/отладке элемента, в котором было заполнено свойство **От имени (отображаемое имя)**, можно увидеть в консоли ошибку:
```
...
Это означает, что у пользователя недостаточно прав на использование функциональности.
