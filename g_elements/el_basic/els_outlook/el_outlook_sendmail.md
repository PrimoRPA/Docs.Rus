...
1. **Имя аккаунта** *[String]* - имя учетной записи Outlook, c адреса которой необходимо отправить письмо. Если в профиле только одна учетная запись, то свойство можно не заполнять. Имя можно узнать в разделе **Файл > Настройка учетных записей** меню Outlook. Пример:
