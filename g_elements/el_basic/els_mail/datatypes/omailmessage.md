...
| ConversationTopic | Это вообще рабочее свойство?                              | Только для Outlook. Тема для потока беседы. Беседа содержит все связанные сообщения в одной беседе с одинаковой строкой темы. Темой беседы обычно является тема первого сообщения электронной почты в потоке. Подробнее о беседах в Outlook см. [здесь](https://support.microsoft.com/ru-ru/office/%D0%BE%D0%B1%D1%89%D0%B8%D0%B5-%D1%81%D0%B2%D0%B5%D0%B4%D0%B5%D0%BD%D0%B8%D1%8F-%D0%BE-%D0%B1%D0%B5%D1%81%D0%B5%D0%B4%D0%B0%D1%85-0eeec76c-f59b-4834-98e6-05cfdfa9fb07). У письма в беседе могут быть заполнены как Subject, так и ConversationTopic. Пример значений для отправленного письма: Subject - `"Re: Скоро отпуск"`,  ConversationTopic - `"Скоро отпуск"` |
...
| MessageProperties | Какой тип данных? | Свойства письма. (Мише: Только для Outlook? Там в "Чтении писем" есть свойство "Читать свойства", а в "Чтении писем" Exchange его нет)  |
...
1. Все свойства, начинающиеся со слова **Send**, в настоящее время не несут информации и имеют пустое значение. Это такие свойства, как: SendTo, SendСс, SendВсс, SendOnBehalf.
2. 
