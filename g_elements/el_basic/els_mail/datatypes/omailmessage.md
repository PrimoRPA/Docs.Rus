...
| MessageType |                                                                 | Тип письма. Пример значения: `Message` |
...
| ReplyAll    | Boolean                                                         | ? для отпр или для вход? Ответить всем. Пример значения: `False`  |
