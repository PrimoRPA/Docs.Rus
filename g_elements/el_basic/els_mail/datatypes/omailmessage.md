...
| PR_SENDER_EMAIL_ADDRESS  | String | Адрес почты отправителя. Подробнее см. [здесь](https://learn.microsoft.com/ru-ru/office/client-developer/outlook/mapi/pidtagsenderemailaddress-canonical-property). Пример значения: `/O=CS24 EXCHANGE/OU=EXCHANGE ADMINISTRATIVE GROUP (FYDIBOHF23SPDLT)/CN=RECIPIENTS/CN=361786F4F0444280A5B6FAF5AE5A79D3-TALANCEVA` - это стандартный вид для этого поля? как его расшифровать?  |
