...
| Body        | String                                                          | Текст тела письма. В Exchange тело будет представлено только в HTML, в Outlook - может быть в виде простого текста (PLAIN) |
| HTMLBody    | String                                                          | Только для Outlook. Текст тела письма в формате HTML  |
