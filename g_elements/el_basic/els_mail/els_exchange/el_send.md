...
1. **Копировать в папку** *[Boolean]* - определяет, нужно ли сохранять копию письма в папке «Отправленные». Если папку нужно изменить, заполните свойство **Папка копирования**. По умолчанию чекбокс выключен - копия не сохраняется.
