...
С версии 24.4 к работе ветвления в **Pick branch** добавлена функциональность, позволяющая задать действие по умолчанию для ситуаций, когда не срабатывает ни один из условных ветвей Pick branch.
