...
## Улучшения в Pick Branch

Начиная с версии 24.4 к работе ветвления в **Pick branch** добавлена функциональность, позволяющая задать действие по умолчанию для ситуаций, когда не срабатывает ни один из условных ветвей Pick branch.
Для настройки действия по умолчанию используется элемент **Wait**, вставленный в триггер действия. Если за заданный период времени не происходит активации других триггеров, срабатывает действие по умолчанию.
