...
| Число     | Int32   | Количество попыток выполнения действия (-ий), помещенного в контейнер. Если число задано, и оно не равно нулю, то действие будет выполняться указанное количество раз. Если число **не** задано, то количество попыток будет равняться 1 |
