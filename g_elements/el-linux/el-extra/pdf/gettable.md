...
Чтобы элемент стал доступен в Студии, необходимо установить NuGet-пакет [Primo.Office.Pdf.Linux](https://docs.primo-rpa.ru/primo-rpa/g_elements/el-extra/pdf). Данный пакет совместим только со Студией версии 1.24.8 и выше.
