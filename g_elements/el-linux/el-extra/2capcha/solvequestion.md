...
1. **Вопрос\*** *[String]* — текст вопроса. Считать текст вопроса можно браузерным элементом **Получить текст**, результат сохранить в переменную и затем указать название переменной в этом свойстве. 
