...
Возможно настроить кэширование проекта для более быстрого выполнения роботом. Кэширование настраивает администратор в конфигурационном файле Оркестратора. См. подробности в [этом разделе](https://docs.primo-rpa.ru/primo-rpa/orchestrator/settings/project-caching).
