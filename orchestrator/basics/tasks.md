...
Одному заданию может быть одновременно назначено несколько триггеров. При этом нужно следить, чтобы триггеры не вступали в логическое противоречие для RPA-проекта задания. Также убедитесь, что триггеры не вступают в логическое противоречие для разных заданий.
...
* Для задания с триггером **Запуск по расписанию** нужно выбрать готовое расписание из справочника. В справочник попадают расписания, созданные ранее на вкладке **Расписания**. Оно может быть согласовано с производственным календарем. 
