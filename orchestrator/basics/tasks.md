...
* Для задания с триггером **Запуск по расписанию** можно создать расписание в этой же форме или выбрать существующее из справочника. В справочник попадают расписания, созданные ранее на вкладке **Расписания**, а также те, что были сохранены вместе с заданиями, если для которых был выбран триггер по расписанию. Расписание может быть согласовано с производственным календарем. 
