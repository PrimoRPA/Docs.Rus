...
* Для работы триггера **Запуск по расписанию** нужно выбрать готовое расписание из справочника. В справочнике находятся расписания, предварительно созданные на вкладке **Расписания**. Они могут быть согласованы с [производственным календарем](https://docs.primo-rpa.ru/primo-rpa/orchestrator/settings/calendar). 
