...
| -------------- | ------ | ------------------------------------------ |
| Запуск по расписанию    | Срабатывает по фиксированному расписанию | Расписание, заданное Cron-строкой или конструктором. Расписание должно быть предварительно задано в справочнике расписаний. <br>Можно настроить на закрытие робота (чекбокс **Завершение робота**), если в данный момент робот выполняет проект по заданию |
