...
| -------------- | ------ | ------------------------------------------ |
| Запуск по расписанию    | Срабатывает по фиксированному расписанию | Расписание, заданное Cron-строкой или конструктором. Расписание должно быть предварительно задано в справочнике расписаний. <br>Триггер может быть настроен на закрытие робота (чекбокс **Завершение робота**), если в данный момент робот выполняет проект по заданию |
