...
Кэширование проекта настраивается в конфиге Оркестратора (C:\Primo\WebApi\appsettings.ProdWin.json или C:\Primo\WebApi\appsettings.ProdLinux.json). Для включения кэширования установите в параметре **AllowCaching** значение true:
