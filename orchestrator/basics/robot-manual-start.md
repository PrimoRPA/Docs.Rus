...
Кэширование проекта настраивается администратором в конфигурационном файле Оркестратора - см. [инструкцию](https://docs.primo-rpa.ru/primo-rpa/orchestrator/deployment/fine-tuning/project-caching).
