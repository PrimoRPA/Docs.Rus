...
С версии Оркестратора 1.24.6 во вкладке **Ресурсы** в форме **Добавить ресурс** и **Редактировать ресурс** добавлены новые поля: `Тип внешнего хранилища` и `Учетная запись CyberArk`. Эти поля позволяют пользователям выбирать источник учетных данных и учетную запись в системе CyberArk, обеспечивая тем самым безопасное управление доступом к чувствительным данным. 
