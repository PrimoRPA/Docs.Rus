...
#### Общие:
1. **Архив (zip)**\* - архив RPA-проекта. Нажмите на иконку, чтобы выбрать файл. После чего для выбранного проекта отобразится список процессов. Кликните по выпадающему списку, чтобы указать стартовый процесс.
