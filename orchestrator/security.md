...
В Оркестраторе существует возможность интеграции с CyberArk. 
...
Если в Оркестраторе настроена интеграция с CyberArk, то для [ресурса](https://docs.primo-rpa.ru/primo-rpa/orchestrator/basics/assets#dobavit-resurs) с типом данных `Credentials` (учетная запись) появляется возможность выбрать CyberArk в качестве типа внешнего хранилища, а затем — возможность выбрать учетную запись из CyberArk.
