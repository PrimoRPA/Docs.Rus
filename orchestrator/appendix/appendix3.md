...
Таблица 6 – Перечень событий Оркестратора
...
| 9.                     | 201   | RoleCreated                                      | Роль создана                                                                                                |
| 10.                    | 202   | RoleChanged                                      | Роль изменена                                                                                               |
| 11.                    | 203   | RoleDeleted                                      | Роль удалена                                                                                                |
| 12.                    | 204   | RolePermissionsAssigned                          | Роли назначены права                                                                                        |
| 13.                    | 301   | WorkerCreated                                    | Машина зарегистрирована                                                                                     |
| 14.                    | 302   | WorkerChanged                                    | Машина изменена                                                                                             |
| 15.                    | 303   | WorkerDisabled                                   | Машина выведена из эксплуатации                                                                             |
| 16.                    | 304   | WorkerRebootStarted                              | Перезагрузка машины запущена                                                                                |
| 17.                    | 305   | WorkerRebootCompleted                            | Перезагрузка машины завершена                                                                               |
| 18.                    | 306   | WorkerTestAvailable                              | Машина доступна                                                                                             |
| 19.                    | 307   | WorkerTestNotAvailable                           | Машина не доступна                                                                                          |
| 20.                    | 308   | WorkerIpAddressSended                            | Машина робота отправила свой IP Оркестратору                                                                |
| 21.                    | 401   | ProjectCreated                                   | Проект создан                                                                                               |
| 22.                    | 402   | ProjectChanged                                   | Проект изменен                                                                                              |
| 23.                    | 403   | ProjectDisabled                                  | Проект выведен из эксплуатации                                                                              |
| 24.                    | 404   | ProjectRun                                       | Проект запущен                                                                                              |
| 25.                    | 405   | ProjectAddedRobot                                | К проекту добавлен робот                                                                                    |
| 26.                    | 406   | ProjectDeletedRobot                              | Из проекта удален робот                                                                                     |
| 27.                    | 407   | ProjectChangedRobotOrder                         | Изменение приоритета роботов проекта                                                                        |
| 28.                    | 408   | ProjectEnqueue                                   | Проект добавлен в очередь выполнения                                                                        |
| 29.                    | 410   | ProjectReEnqueue                                 | Проект добавлен в очередь выполнения повторно                                                               |
| 30.                    | 409   | ProjectPeek                                      | Проект извлечен из очереди выполнения                                                                       |
| 31.                    | 411   | ProjectSwappedMainVersionUp                      | Проект назначен главной версией                                                                             |
| 32.                    | 412   | ProjectSwappedMainVersionDown                    | Проект больше не является главной версией                                                                   |
| 33.                    | 413   | ProjectVersionCreated                            | Версия проекта создана                                                                                      |
| 34.                    | 414   | ProjectDeletedFromQueue                          | Проект удален из очереди на выполнение                                                                      |
| 35.                    | 415   | ProjectDownloaded                                | Скачан архив проекта                                                                                        |
| 36.                    | 501   | RobotCreated                                     | Робот зарегистрирован                                                                                       |
| 37.                    | 502   | RobotDisabled                                    | Робот выведен из эксплуатации                                                                               |
| 38.                    | 503   | RobotDeployStarted                               | Развертывание робота запущено                                                                               |
| 39.                    | 504   | RobotStartStarted                                | Старт робота запущен                                                                                        |
| 40.                    | 505   | RobotStartCompleted                              | Старт робота завершен                                                                                       |
| 41.                    | 506   | RobotEraseStarted                                | Стирание робота запущено                                                                                    |
| 42.                    | 507   | RobotEraseCompleted                              | Стирание робота завершено                                                                                   |
| 43.                    | 508   | RobotProjectRun                                  | Проект на роботе запущен                                                                                    |
| 44.                    | 509   | RobotProjectStopped                              | Проект на роботе остановлен                                                                                 |
| 45.                    | 510   | RobotDeployCompleted                             | Развертывание робота завершено                                                                              |
| 46.                    | 511   | RobotStartError                                  | Ошибка при запуске робота                                                                                   |
| 47.                    | 512   | RobotProjectCompletedSuccess                     | Зафиксировано удачное завершение выполнения проекта роботом                                                 |
| 48.                    | 513   | RobotProjectCompletedError                       | Зафиксировано не удачное завершение выполнения проекта роботом                                              |
