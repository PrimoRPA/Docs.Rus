...
Описанное выше поведение очереди можно изменить на очередь с гарантированным порядком запуска проектов. Она будет работать на основе опроса БД по принципу:
