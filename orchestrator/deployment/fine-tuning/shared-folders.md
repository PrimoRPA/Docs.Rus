...
* **RootFolderDefaultAccess** - доступ к корневой папке. По умолчанию установлено `true` - корневая папка доступна всем пользователям, включая AD-пользователей, без ограничения прав. При установке значения `false` объекты корневой папки станут недоступны пользователям.
