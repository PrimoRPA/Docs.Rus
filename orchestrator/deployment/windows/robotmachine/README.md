...
Установить Агента на машине Робота можно двумя способами:
* из инсталлятора;
* без него.
 
В этой инструкции описывается установка Агента и настройка машины Робота из инсталлятора `AgentInstaller.zip`. Оркестратор должен быть предварительно развернут и настроен.
