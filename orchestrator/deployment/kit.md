...
Дистрибутивы роботов с версии 23.5 больше не входят в комплект поставки и распространяются отдельно. Оркестраторные роботы имеют название `Primo.Robot.<архитектура>.Orchestrator.<версия робота>.zip` - обязательно должно быть слово **.Orchestrator**.
