...
* 53 файла документации (папка `Docs`). 

С версии 23.5 дистрибутивы роботов больше не входят в комплект поставки и распространяются отдельно. Оркестраторные роботы имеют название вида:\
