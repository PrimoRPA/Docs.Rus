...
Сначала требуется установить компоненты для подсистемы **Оркестратор**. Ниже приведены шаги установки, которые должны выполняться последовательно. 
...
После установки ОС на машине Оркестратора необходимо выполнить её предварительную настройку. Следуйте инструкциям: 
...
Установка PostgreSQL (+pgbouncer) или MS SQL SERVER.
...
Изначально можно пропустить этот шаг и вернуться к нему позже.
