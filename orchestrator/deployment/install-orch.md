...
| 8. Установка RDP2              | См. примечания к п.4. <p>Может быть установлен на сервере Оркестратора либо на отдельном сервере Windows. **Не следует устанавливать RDP2 на машине робота**</p>     |
