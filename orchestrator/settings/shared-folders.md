...
* из формы **Все общие папки** — выберите некорневую папку, объекты которой нужно делегировать одному или нескольким пользователям;
* из формы **Пользователи** — выберите пользователя, которому нужно делегировать некорневую папку.
