...
На рисунке ниже представлено делегирование папки из раздела **Настройки > Пользователи**. Нажмите значок `>` рядом с пользователем, чтобы увидеть функцию делегирования папок.
