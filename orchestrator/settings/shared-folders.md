...
* из формы **Все общие папки** — выберите некорневую папку, объекты которой нужно делегировать нескольким пользователям;
* из формы **Пользователи** — выберите пользователя, которому нужно делегировать конкретную папку.
