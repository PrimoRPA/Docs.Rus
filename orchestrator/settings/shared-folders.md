...
1.	**Очередь обмена данными — в настоящий момент может располагаться только в корневой папке. Возможность работы с некорневыми папками в разработке**.
1.	**Ресурс — в настоящий момент может располагаться только в корневой папке. Возможность работы с некорневыми папками в разработке**.
