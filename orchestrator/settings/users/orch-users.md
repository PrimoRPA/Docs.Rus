...
С версии 1.24.8 в Оркестраторе была отключена возможность удаления учетных записей пользователей, которые в данный момент залогинены в системе. Это изменение добавлено для повышения безопасности и предотвращения потенциальных сбоев в работе системы. При попытке удалить активного пользователя будет выведено сообщение об ошибке, уведомляющее о невозможности выполнения этого действия.
