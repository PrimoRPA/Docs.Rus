...
:white_check_mark: Результат: новая учетная запись отобразится в таблице раздела **Пользователи**. Чтобы изменить параметры пользователя, выделите его учетную запись и нажмите кнопку **Редактировать**.
