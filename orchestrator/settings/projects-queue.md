...
В разделе **Настройки ➝ Стратегия очереди проектов** определяется стратегия назначения Роботов на выполнение RPA-проекта. Стратегию настраивает администратор Оркестратора глобально для всех тенантов. Настройка для каждого тенанта в отдельности задается в конфигурационном файле (см. в [подразделе ниже](https://docs.primo-rpa.ru/primo-rpa/orchestrator/settings/projects-queue#nastroika-strategii-dlya-otdelnogo-tenanta)).
