...
В разделе **Настройки ➝ Стратегия очереди проектов** определяется стратегия назначения Роботов на выполнение RPA-проекта. Стратегию настраивает администратор Оркестратора глобально для всех тенантов. Стратегию для каждого отдельного тенанта можно задать только в конфигурационном файле.
