...
**Подробнее о разрядности**: имеются дистрибутивы (x86 и 64) для Windows и дистрибутив (64) для Linux. Возможности автоматизации UI рабочего стола в Linux отличаются от возможностей под Windows и зависят от типа используемого рабочего стола. 
