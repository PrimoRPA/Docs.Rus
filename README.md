...
![](<.gitbook/assets/logo_4.png>)

Primo RPA - это российская система для роботизации бизнес-процессов.
...
В систему Primo RPA входит следующее программное обеспечение:
* Primo RPA Studio
* Primo RPA Robot
