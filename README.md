...
Ключевые возможности:
1. **Централизованное управление лицензиями на продукты Primo RPA**. Получение лицензий на выбранные продукты и управление ими через интерфейс Оркестратора.
2. **Централизованное управление роботами**. Развертывание и настройка роботов, логирования, регистрация машин роботов, разбиение роботов на группы для независимого управления, возможность привязки к роботу RDP-пользователя.
...
7. **Мониторинг работы роботов**. Логирование работы роботов, просмотр журнала. 
8. **Мультитенантность**. Система позволяет создавать тенанты - филиал организации. В рамках тенанта доступно управление машинами Роботов и управление пользователями тенанта.
12. **Интеграция с внешними системами**. 
13. **Интеграция с Active Directory**. 
