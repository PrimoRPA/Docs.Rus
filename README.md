...
Для установки и эксплуатации ПО Primo RPA Studio компьютер пользователя должен соответствовать требованиям:
...
Для установки и эксплуатации ПО Primo RPA Robot (работающего как с Оркестратором, так и без него) необходимо, чтобы машина робота соответствовала требованиям:
