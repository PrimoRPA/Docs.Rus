...
1. В разделе **Роботы** выберите существующего робота или создайте нового.
...
3. Важно понимать, что опция "Закрыть RDP-сессию" имеет приоритет над **Поддерживать RDP-сессию**. Если опция **Закрыть RDP-сессию** активирована, то RDP - сессия будет закрыта по завершении проекта.
