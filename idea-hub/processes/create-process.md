...
По умолчанию ограничено количество полей идеи, значения которых переносятся в созданный процесс после того, как идея была предложена. 

Это поля:
* title ​— название процесса;
* body ​— описание процесса;
* field_area ​— департамент, к которому относится процесс;
* field_systems ​— системы, задействованные в процессе.
