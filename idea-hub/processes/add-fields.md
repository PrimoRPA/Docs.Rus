...
Если активировать переключатель **Сделать прописной буквой первый символ в строке** в процессе импорта, то первая буква значения поля будет меняться на заглавную, если она была строчной.
