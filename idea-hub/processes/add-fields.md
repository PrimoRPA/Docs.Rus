...
Переключатель **Сделать прописной буквой первый символ в строке** определяет, нужно ли первую букву значения поля будет менять на заглавную, если она была строчной.
