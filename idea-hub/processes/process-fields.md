...
**Описание**: Название процесса, которое указывается пользователем вручную, когда он создает идею или редактирует процесс.
...
**Описание**: Уникальный идентификатор процесса, который автоматически присваивается сервером при создании идеи. Идентификатор возможно изменить при редактировании процесса.
...
**Тип поля**: [Entity reference](https://docs.primo-rpa.ru/primo-rpa/primo-rpa-idea-hub/processes/field-types#entity_reference)
