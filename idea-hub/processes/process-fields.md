...
Ниже приведены описания встроенных полей процесса, информация о способах их отображения и процессах расчёта значений полей.

Список предустановленных полей процесса:
* Название
* Ключ для расчёта
* Описание
* Департамент
