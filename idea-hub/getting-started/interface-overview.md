...
Если нажать на карточку процесса, то откроется дашборд с набором информационных панелей, где содержится полная информация о процессе. Как и в случае с дашбордом на главной странице, каждая панель гибко редактируется, а их набор можно сократить или расширить.
