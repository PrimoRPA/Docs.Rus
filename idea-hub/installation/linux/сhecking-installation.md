...
1. При наличии "Ошибок" или "Предупреждений" об этом **НЕОБХОДИМО** сообщить разработчикам.
1. Разработчики сообщат о том какие вещи необходимо исправить и скорее всего подключатся для помощи.
