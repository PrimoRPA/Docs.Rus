...
| revenue_real      | ?                  | Фактический эффект. Действительный (фактический) эффект в деньгах. Может быть любым значением или формулой Idea Hub. Данный показатель используется в расчетах. Если значение в поле указано в виде числа, то оно будет рассматриваться, как эффект от данного процесса, выраженный в рублях | Формула |
