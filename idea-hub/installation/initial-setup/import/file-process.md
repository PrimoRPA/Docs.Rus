...
| dev_cost          | Нет                  | Стоимость разработки. Стоимость разработки автоматизированного процесса, **в млн. рублей - актуальное уточнение?** | Число |
| dev_started       | Нет                 | Дата начала разработки. Стоимость разработки автоматизированного процесса | ДД.ММ.ГОД. Пример: `16.05.2024` |
