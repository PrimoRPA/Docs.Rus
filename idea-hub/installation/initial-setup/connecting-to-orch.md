...
Следующий шаг — перейти в веб-интерфейс Idea Hub, чтобы создать контуры организации и указать для них каталоги, из которых Idea Hub будет забирать полученные данные из Оркестратора.
