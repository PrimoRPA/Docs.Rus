...
Машина, на которой будет запускаться скрипт `get_data.ps1`, должна работать под OC Windows. По умолчанию это машина Оркестратора, на которой установлена БД MSSQL.
