...
Все переменные ниже задаются для каждого окружения отдельно, с суффиксом в виде имени этого окружения. Необязательно использовать имя "PROD"; замените имя на необходимое вам. Например:
