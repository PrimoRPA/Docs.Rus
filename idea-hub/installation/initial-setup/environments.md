...
Для каждого контура возможно настроить подключение к источнику данных для импорта в Idea Hub. В частности, чтобы Idea Hub мог синхронизироваться с Оркестратором для получения данных о проектах, очередях обмена данными и т.п.
