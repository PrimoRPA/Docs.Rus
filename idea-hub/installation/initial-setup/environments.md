...
Названия контуров, которые вы создадите, следует указать при настройке файла `.env` для корректной работы скрипта `get_data.sh`.
...
В поле **Тип исходных данных** выберите в качестве источника данных **Primo RPA Global** — для импорта данных из Оркестратора.
