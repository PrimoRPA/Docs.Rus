...
## Что дальше
Следующий шаг — импортировать в Idea Hub файл с процессами, для которых вы настроили сбор статистики из Оркестратора. Импорт процессов выполняется с помощью загрузки файла `process.xlsx`, который позволяет массово добавить в Idea Hub все существующие процессы вместо того, чтобы создавать каждый из них вручную.
