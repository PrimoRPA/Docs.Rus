...
Раздел **Пользователи** позволяет управлять пользователями, которые были перенесены в Idea Hub при импорте данных, а также добавлять новых пользователей, роли, настраивать права доступа для ролей.
