...
В разделе настройки учётной записи вы также можете определить настройки входа в Idea Hub, настройки удаления учётной записи и тексты писем автоматических уведомлений.
