...
В разделе **Расширения** вы можете установить дополнительные модули, чтобы расширить функциональные возможности Idea Hub. Например, вы можете настроить интеграцию с LDAP или 
