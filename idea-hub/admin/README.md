...
Раздел **Структура > Таксономия** используется для классификации содержимого сайта. Для этого используются *термины*, сгруппированные по *словарям*. 
...
В Idea Hub используется фиксированный список терминов, который создается и управляется администратором, а пользователи могут выбирать только из существующего списка при редактировании контента.
