...
1. В параметре **Select which data you want to import** - какие данные мы забираем из Орка:
   ...
   * Licenses - список существующих лицензий, который есть в Оркестраторе. Обязательно вместе с галкой LicenseTypesOrch. 
