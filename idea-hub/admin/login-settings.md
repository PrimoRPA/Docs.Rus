...
Перед эксплуатацией Idea Hub определите настройки учётных записей и возможные уведомления, которые будут отправляться на электронную почту пользователей. Данные настройки выполняются пользователем с административными правами.
