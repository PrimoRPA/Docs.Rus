...
1. В разделе **Владелец систем** вы можете указать, с какими информационными системами знаком пользователь. Кликните в поле **Системы**, чтобы увидеть список доступных систем. Системы заранее добавляются в Idea Hub в разделе **Таксономия**.
