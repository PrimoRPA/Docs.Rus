...
Также Idea Hub предоставляет инструменты для массового редактирования выбранных пользователей. Чтобы воспользоваться этой возможностью:
...
Аналогичным образом можно массово изменить роль или заблокировать/разблокировать выбранных пользователей. Для этого разверите список в поле **Action** и выберите нужное действие, после чего также нажмите **Применить к отмеченным позициям**.
