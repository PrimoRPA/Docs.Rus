...
По умолчанию только пользователю с ролью **Администратор** доступен просмотр и редактирование формы с правилами доступа для объектов, терминов таксономии и полей процесса. Если вы хотите назначить какой-либо роли или ролям эти разрешения, то установите для них следующие права:
