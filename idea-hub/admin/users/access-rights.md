...
Доступ на уровне модулей и функций настраивается в разделе административного меню **Пользователи** на вкладке **Права доступа**. 

Доступ назначается ролям пользователей. Если пользователю назначены несколько ролей, то права доступа этих ролей будут суммироваться.


**Не используйте** данный раздел для установки прав доступа к терминам таксономии, объектам, а также к полям процессов — доступ к ним настраивается с помощью правил в соответствующих разделах. Вкладку **Права доступа** рекомендуется использовать только для всех прочих разрешений. Например, если вы хотите определить, каким ролям требуется предоставить права на управление/просмотр учётных записей — соответствующие разрешения сгруппированы в модуле **User**.
