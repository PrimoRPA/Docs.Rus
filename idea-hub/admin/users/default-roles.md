...
* у роли **Администратор** изменить права доступа невозможно;
* у ролей **Анонимный пользователь** и **Аутентифицированный пользователь** права доступа доступны для редактирования.
