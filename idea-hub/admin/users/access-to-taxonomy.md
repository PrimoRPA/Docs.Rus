...
Вы можете настроить правила доступа к терминам выбранного словаря, чтобы определить, какие операции с терминами будут разрешены пользователю. Управление доступом к перечисленным объектам выполняется в разделе административного меню **Структура > Таксономия**.
...
Такие операции, как обновить, читать, удалить разрешают соответствующие действия с терминами как на странице **Структура > Таксономия**, так и на странице **Департаменты**, которая доступна через пользовательском меню.
...
* **Термин таксономии выбранный для пользователя** — позволяет назначить доступ к терминам выбранного словаря. 
