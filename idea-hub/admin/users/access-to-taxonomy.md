...
1. Откроется форма редактирования правил. Для каждой операции требуется отдельно установить правила доступа.
   ...
   | То же значение                                | **Роли с доступом** —  <p> **Поле пользователя** —   </p>  <p> **Целевое поле** —   </p> |
   | Термин таксономии выбранный для пользователя  | **Роли с доступом** —  <p> **Поле пользователя** —  </p>  <p> **Включить термины** —  </p> |
