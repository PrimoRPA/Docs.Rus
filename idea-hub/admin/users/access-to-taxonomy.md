...
1. Для операций **Создать**, **Обновить**, **Удалить** настроим параметры:
   * **Тип правила** — выберем значение `Роль`.
   * **Роли с доступом\*** — удалим значение `Authenticated user`, а вместо него установим **Администратор**.
1. Нажмём **Сохранить правила** внизу страницы.
1. Чтобы сразу применить настройки, нажмём **Перестроить права доступа**.
...
![](<../../../idea-hub/resources/admin/users/areas-access-result-without-actions.png>)
...
![](<../../../idea-hub/resources/admin/users/areas-access-result.png>)
