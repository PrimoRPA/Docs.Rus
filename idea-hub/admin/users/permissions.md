...
Пользователь с ролью **Авторизованный пользователь** (входит в поставку) по умолчанию имеет все права на операции с объектами и терминами таксономии: чтение + создание + изменение + удаление. 
