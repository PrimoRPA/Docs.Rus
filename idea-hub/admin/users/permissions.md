...
Форма с настройками правил доступа имеет одинаковый вид как для объектов, так и для терминов словаря таксономии.

### Пример настройки правила доступа к объекту

Рассмотрим, как установить правило доступа к такому объекту, как процесс. Для этого:
