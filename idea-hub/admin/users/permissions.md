...
1. Выберем для настройки операцию **Читать**. Например, мы хотим, чтобы просматривать процесс могли все бизнес-аналитики, связанные с данным процессом. Тогда в параметре:
