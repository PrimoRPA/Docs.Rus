...
Администратор может разграничивать доступ к таким объектам, как процесс, проект, очередь, робот, машина, лицензия, дашборд.

Кроме того, ему доступна настройка прав доступа к терминам словаря таксономии — например, к терминам словаря департаментов.
