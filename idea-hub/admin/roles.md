...
Для каждой роли, кроме Администратора и Анонимного пользователя, следует назначить права доступа на странице административного меню **Пользователи**, вкладка **Права доступа**.
