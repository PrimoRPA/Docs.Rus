...
Idea hub поставляется со ролями по умолчанию, которые представлены в таблице ниже. Вы можете добавить собственные роли, или изменить существующие (например изменить название).
